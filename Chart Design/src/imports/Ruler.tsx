...
import svgPaths from "./svg-929jo99hti";
...
function Ruler1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute h-[384px] left-[374px] top-[248px] w-[826px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 826 384">
        <g id="ruler">{children}</g>
      </svg>
    </div>
  );
}
              ...
              <div className="absolute inset-[12.5%_8.33%_8.33%_12.5%]">
                <div className="absolute inset-[-2.63%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                    <g id="icon">
                      <rect height="17" id="Rectangle 33" rx="0.5" stroke="var(--stroke-0, #1F1F1F)" width="17" x="1.5" y="1.5" />
                      <g id="arrows">
                        <path d={svgPaths.pb09f380} id="Vector" stroke="var(--stroke-0, #1F1F1F)" strokeLinecap="round" strokeLinejoin="round" />
                        <path d={svgPaths.pd25d700} id="Vector_2" stroke="var(--stroke-0, #1F1F1F)" strokeLinecap="round" strokeLinejoin="round" />
                      </g>
                      <path d={svgPaths.p1b49b1f0} fill="var(--fill-0, white)" id="Vector_3" stroke="var(--stroke-0, #1F1F1F)" strokeLinecap="round" strokeLinejoin="round" />
                      <path d={svgPaths.p3302e140} fill="var(--fill-0, white)" id="Vector_4" stroke="var(--stroke-0, #1F1F1F)" strokeLinecap="round" strokeLinejoin="round" />
                    </g>
                  </svg>
                </div>
              </div>
        ...
        <div className="content-stretch flex flex-col items-start relative shrink-0">
          <div className="relative shrink-0 size-[48px]" data-name="button/tool/default">
            ...
            <div className="absolute inset-1/4" data-name="icons/ruler">
              <div className="absolute contents inset-[8.34%_4.16%_4.16%_8.34%]">
                <div className="absolute flex inset-[8.34%_4.16%_4.16%_8.34%] items-center justify-center">
                  <div className="-rotate-45 flex-none h-[6.988px] w-[22.711px]">
                    <div className="relative rounded-[0.3px] size-full">
                      <div aria-hidden="true" className="absolute border border-[#00b1c7] border-solid inset-[-0.5px] pointer-events-none rounded-[0.8px]" />
                    </div>
                  </div>
                </div>
                <Helper2 additionalClassNames="inset-[64.95%_73.65%_24.75%_16.06%]" />
                <Helper3 additionalClassNames="inset-[57.23%_63.36%_29.9%_23.77%]" />
                <Helper3 additionalClassNames="inset-[41.79%_47.92%_45.34%_39.22%]" />
                <Helper3 additionalClassNames="inset-[26.35%_32.48%_60.78%_54.66%]" />
                <Helper2 additionalClassNames="inset-[49.51%_58.21%_40.2%_31.5%]" />
                <Helper2 additionalClassNames="inset-[34.07%_42.77%_55.64%_46.94%]" />
                <Helper2 additionalClassNames="inset-[18.63%_27.33%_71.08%_62.38%]" />
              </div>
            </div>
          </div>
          <ButtonToolDefault className="relative shrink-0 size-[48px]" />
  ...
  return (
    <div className={clsx("absolute flex items-center justify-center", additionalClassNames)}>
      <div className="-rotate-45 flex-none h-[3.494px] w-[0.873px]">
        <div className="bg-[#00b1c7] rounded-[1px] size-full" />
      </div>
    </div>
  );
}
...
function ChartLayout() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <Helper1 additionalClassNames="top-[47px]" />
      <Helper1 additionalClassNames="top-[12px]" />
      <Helper1 additionalClassNames="top-[82px]" />
      <Helper1 additionalClassNames="top-[117px]" />
      <Helper1 additionalClassNames="top-[187px]" />
      <Helper1 additionalClassNames="top-[222px]" />
      <Helper1 additionalClassNames="top-[292px]" />
      <Helper1 additionalClassNames="top-[327px]" />
      <Helper1 additionalClassNames="top-[397px]" />
      <Helper1 additionalClassNames="top-[432px]" />
      <Helper1 additionalClassNames="top-[502px]" />
      <Helper1 additionalClassNames="top-[537px]" />
      <Helper1 additionalClassNames="top-[607px]" />
      <Helper1 additionalClassNames="top-[642px]" />
      <Helper1 additionalClassNames="top-[152px]" />
      <Helper1 additionalClassNames="top-[257px]" />
      <Helper1 additionalClassNames="top-[362px]" />
      <Helper1 additionalClassNames="top-[467px]" />
      <Helper1 additionalClassNames="top-[572px]" />
      <Helper1 additionalClassNames="top-[677px]" />
      <Helper1 additionalClassNames="top-[712px]" />
  ...
  return (
    <div className="absolute contents left-0 top-[739px]">
      ...
      <div className="absolute contents left-[342px] top-[740px]">
        ...
        <Helper additionalClassNames="left-[374px]" />
    ...
    <div className={className || "relative size-[40px]"} data-name="button/round/default">
      <div className="absolute inset-[-80%_-102.5%_-120%_-97.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 120">
          <g filter="url(#filter0_d_19_72995)" id="round_bg">
            <circle cx="59" cy="52" fill="var(--fill-0, white)" fillOpacity="0.9" r="20" />
            <circle cx="59" cy="52" r="19.5" stroke="var(--stroke-0, #F8F8FF)" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="120" id="filter0_d_19_72995" width="120" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_19_72995" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_19_72995" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
export default function Ruler() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Ruler">
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[103px] text-black top-[96px] uppercase whitespace-nowrap">Ruler</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[338px] whitespace-nowrap">Up</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1659px] not-italic text-[70px] text-black top-[338px] whitespace-nowrap">Down</p>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1659px] overflow-clip top-[503px] w-[1440px]" data-name="Ruler_down">
        ...
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <TimeLine text="12" text1="9" text2="5" text3="3" text4="Oct" text5="7" text6="28" text7="25" text8="23" text9="21" text10="18" text11="16" text12="14" text13="11" text14="9" text15="7" text16="5" text17="3" text18="Sep" text19="30" />
          <RighstSideBar />
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <div className="absolute h-[740px] left-0 overflow-clip top-0 w-[1304px]" data-name="bars">
              <Bars />
              <div className="absolute contents left-[374px] top-[248px]" data-name="ruler">
                <Ruler1>
                  <rect fill="var(--fill-0, #FF6B5C)" fillOpacity="0.05" height="384" id="bg" width="826" x="6.10352e-05" />
                  <path d={svgPaths.p38e42080} fill="var(--stroke-0, #F26D60)" id="arrow" />
                  <path d={svgPaths.p3fdc080} fill="var(--stroke-0, #F26D60)" id="arrow_2" />
                </Ruler1>
                <div className="absolute bg-[#ffecec] content-stretch flex items-center left-[714px] opacity-85 px-[10px] py-[4px] rounded-[4px] top-[644px]" data-name="label">
                  <div aria-hidden="true" className="absolute border border-[#f26d60] border-solid inset-0 pointer-events-none rounded-[4px]" />
                  <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f26d60] text-[12px] text-center whitespace-nowrap">
                    <p className="mb-0">-253.14 (-58.51%), -25314</p>
                    <p>136 bars, 136d</p>
                  </div>
                </div>
              </div>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[124px] overflow-clip top-[503px] w-[1440px]" data-name="Ruler_up">
        <FooterBarText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <TimeLine text="12" text1="9" text2="5" text3="3" text4="Oct" text5="7" text6="28" text7="25" text8="23" text9="21" text10="18" text11="16" text12="14" text13="11" text14="9" text15="7" text16="5" text17="3" text18="Sep" text19="30" />
          <RighstSideBar />
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <div className="absolute h-[740px] left-0 overflow-clip top-0 w-[1304px]" data-name="bars">
              <Bars />
              <div className="absolute contents left-[374px] top-[192px]" data-name="ruler">
                <Ruler1>
                  <rect fill="var(--fill-0, #00B1C7)" fillOpacity="0.05" height="384" id="bg" width="826" y="7.62939e-06" />
                  <path d={svgPaths.p1d5131f0} fill="var(--stroke-0, #00B1C7)" id="arrow" />
                  <path d={svgPaths.p5b33200} fill="var(--stroke-0, #00B1C7)" id="arrow_2" />
                </Ruler1>
                <div className="absolute bg-[#dcf5f7] content-stretch flex items-center left-[714px] opacity-85 px-[10px] py-[4px] rounded-[4px] top-[192px]" data-name="label">
                  <div aria-hidden="true" className="absolute border border-[#00b1c7] border-solid inset-0 pointer-events-none rounded-[4px]" />
