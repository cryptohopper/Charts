...
import svgPaths from "./svg-b1fts0d8dw";
...
function TooltipBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<TooltipBackgroundImageProps>) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute bg-[#1f1f1f] content-stretch flex items-center px-[15px] py-[8px] rounded-[3px] top-[calc(50%-1280px)]", additionalClassNames)}>
...
function BackgroundImageAndText2({ text, additionalClassNames = "" }: BackgroundImageAndText2Props) {
  return <BackgroundImage14 additionalClassNames={additionalClassNames}>{text}</BackgroundImage14>;
}
...
function BackgroundImage13({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage13Props>) {
  return <BackgroundImage14 additionalClassNames={clsx("-translate-x-1/2 -translate-y-1/2 absolute bg-[#1f1f1f] content-stretch flex items-center px-[15px] py-[8px] rounded-[3px]", additionalClassNames)}>{children}</BackgroundImage14>;
}
...
type ShortPositionFontSizeBackgroundImageAndTextProps = {
  text: string;
  additionalClassNames?: string;
};

function ShortPositionFontSizeBackgroundImageAndText({ text, additionalClassNames = "" }: ShortPositionFontSizeBackgroundImageAndTextProps) {
...
function BackgroundImageAndText({ text, additionalClassNames = "" }: BackgroundImageAndTextProps) {
  return <BackgroundImageAndText2 text={text} additionalClassNames={clsx("absolute bg-[#1f1f1f] content-stretch flex items-center px-[15px] py-[8px] rounded-[3px] top-[344px]", additionalClassNames)} />;
}
...
function TooltipBackgroundImageAndText({ text, additionalClassNames = "" }: TooltipBackgroundImageAndTextProps) {
  return <BackgroundImageAndText2 text={text} additionalClassNames={clsx("absolute bg-[#1f1f1f] content-stretch flex items-center px-[15px] py-[8px] rounded-[3px] top-[505px]", additionalClassNames)} />;
}
    ...
    <div className="absolute h-[836px] left-0 top-[64px] w-[48px]">
      ...
      <div className="absolute content-stretch flex flex-col gap-[8px] items-center justify-center left-0 top-0">
        <div className="content-stretch flex flex-col items-start relative shrink-0">
          ...
          <ButtonToolDefaultBackgroundImage2 />
          <div className="relative shrink-0 size-[48px]" data-name="button/tool/default">
            <div className="absolute bg-white inset-0" data-name="tool_bg" />
...
function TargetBackgroundImageAndText({ text, additionalClassNames = "" }: TargetBackgroundImageAndTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute bg-[#09977e] content-stretch flex items-center opacity-85 px-[10px] py-[2px] rounded-[4px]", additionalClassNames)}>
...
function StopBackgroundImageAndText({ text, additionalClassNames = "" }: StopBackgroundImageAndTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute bg-[#f26d60] content-stretch flex items-center px-[10px] py-[2px] rounded-[4px]", additionalClassNames)}>
      <div aria-hidden="true" className="absolute border border-[#f6877c] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function LabelBackgroundImageAndText({ text, additionalClassNames = "" }: LabelBackgroundImageAndTextProps) {
  return (
    <div className={clsx("-translate-x-1/2 -translate-y-1/2 absolute bg-[#f26d60] content-stretch flex items-center px-[10px] py-[2px] rounded-[4px]", additionalClassNames)}>
      <div aria-hidden="true" className="absolute border border-[#f6877c] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
        <p className="mb-0">{`Open P&L: -150.86, Qty: 4.697`}</p>
        <p>{text}</p>
      </div>
    </div>
  );
  ...
  return (
    <div className={clsx("absolute flex h-px items-center justify-center w-[461px]", additionalClassNames)}>
      <div className="-scale-y-100 flex-none">
        <div className="bg-[rgba(62,62,62,0.5)] h-px w-[461px]" data-name="line" />
      </div>
    </div>
  );
}
...
function ShortPositionBackgroundImage() {
  return (
    <div className="absolute contents left-[calc(27.78%+35px)] top-[252px]">
      <div className="absolute bg-[rgba(255,107,92,0.1)] h-[209px] left-[calc(27.78%+35px)] top-[252px] w-[461px]" data-name="bg_red" />
      <BackgroundImage9 additionalClassNames="left-[calc(27.78%+35px)] top-[461px]" />
      <div className="absolute bg-[rgba(9,151,126,0.1)] h-[209px] left-[calc(27.78%+35px)] top-[462px] w-[461px]" data-name="bg_green" />
    </div>
  );
}
...
function MenuItemBgColorBackgroundImage1() {
  return (
    <div className="h-[38px] relative shrink-0 w-[48px]">
      <div className="absolute bg-white inset-0" data-name="bg" />
      <div className="absolute bg-size-[auto_auto,40.00000059604645px_40.00000059604645px] bg-top-left bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" style={{ backgroundImage: `linear-gradient(90deg, rgba(46, 167, 144, 0.1) 0%, rgba(46, 167, 144, 0.1) 100%), url('${imgColor}')` }} />
...
function MenuItemBgColorBackgroundImage() {
  return (
    <div className="h-[38px] relative shrink-0 w-[48px]">
      <div className="absolute bg-white inset-0" data-name="bg" />
      <div className="absolute bg-size-[auto_auto,40.00000059604645px_40.00000059604645px] bg-top-left bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" style={{ backgroundImage: `linear-gradient(90deg, rgba(241, 109, 96, 0.1) 0%, rgba(241, 109, 96, 0.1) 100%), url('${imgColor}')` }} />
      <IconsBackgroundColor className="absolute bottom-[18.42%] left-1/4 right-1/4 top-[18.42%]" />
    </div>
  );
}

function MenuItemTextColorBackgroundImage() {
  return (
    <div className="h-[38px] relative shrink-0 w-[48px]">
      <div className="absolute bg-white inset-0" data-name="bg" />
...
function BackgroundImage5() {
  return (
    <div className="absolute bg-white content-stretch flex items-center left-[calc(55.56%-10px)] py-px rounded-[6px] top-[108px]">
      ...
      <BackgroundImage8 />
      <MenuItemTextColorBackgroundImage />
      <BackgroundImage8 />
      <div className="h-[38px] relative shrink-0 w-[48px]" data-name="menu_item/line_color">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <div className="absolute bg-[#3e3e3e] bottom-1/2 left-1/4 right-1/4 rounded-[6px] top-[47.37%]" data-name="thickness" />
        <div className="absolute bg-[rgba(62,62,62,0.5)] bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" />
      </div>
      <BackgroundImage8 />
      <MenuItemBgColorBackgroundImage />
      <BackgroundImage8 />
      <MenuItemBgColorBackgroundImage1 />
      <BackgroundImage8 />
...
function ButtonToolDefaultBackgroundImage2() {
  return (
    ...
    <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]">
      ...
      <div className="absolute contents left-0 top-0">
        <div className="absolute contents left-0 top-0">
          ...
          <div className="absolute contents left-[1304px] top-[178px]">
            <div className="absolute bg-[#f26d60] h-[19px] left-[1304px] top-[178px] w-[64px]" data-name="card_bg" />
          ...
          <div className="absolute contents left-[1304px] top-[598px]">
            <div className="absolute bg-[#09977e] h-[19px] left-[1304px] top-[598px] w-[64px]" data-name="card_bg" />
      ...
      <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]">
        <div className="absolute contents left-0 top-0">
          ...
          <BackgroundImage3 additionalClassNames="top-[47px]" />
          <BackgroundImage3 additionalClassNames="top-[12px]" />
          <BackgroundImage3 additionalClassNames="top-[82px]" />
          <BackgroundImage3 additionalClassNames="top-[117px]" />
          <BackgroundImage3 additionalClassNames="top-[187px]" />
          <BackgroundImage3 additionalClassNames="top-[222px]" />
          <BackgroundImage3 additionalClassNames="top-[292px]" />
          <BackgroundImage3 additionalClassNames="top-[327px]" />
          <BackgroundImage3 additionalClassNames="top-[397px]" />
          <BackgroundImage3 additionalClassNames="top-[432px]" />
          <BackgroundImage3 additionalClassNames="top-[502px]" />
          <BackgroundImage3 additionalClassNames="top-[537px]" />
          <BackgroundImage3 additionalClassNames="top-[607px]" />
          <BackgroundImage3 additionalClassNames="top-[642px]" />
          <BackgroundImage3 additionalClassNames="top-[152px]" />
          <BackgroundImage3 additionalClassNames="top-[257px]" />
          <BackgroundImage3 additionalClassNames="top-[362px]" />
          <BackgroundImage3 additionalClassNames="top-[467px]" />
          <BackgroundImage3 additionalClassNames="top-[572px]" />
          <BackgroundImage3 additionalClassNames="top-[677px]" />
          <BackgroundImage3 additionalClassNames="top-[712px]" />
  ...
  return (
    <div className={clsx("absolute h-[32px] left-[calc(33.33%+13.33px)] w-[91px]", additionalClassNames)}>
      <div className="absolute flex h-[32px] items-center justify-center left-0 right-0 top-0">
        <BackgroundImage1 additionalClassNames="h-[91px] w-[32px]" />
      </div>
...
export default function ShortPosition() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Short Position">
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[103px] text-black top-[96px] uppercase whitespace-nowrap">Short position</p>
      ...
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1015px] not-italic text-[20px] text-black top-[293px] whitespace-nowrap">Extended settings</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[2273px] whitespace-nowrap">Center_raised</p>
      ...
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1656px] not-italic text-[70px] text-black top-[2273px] whitespace-nowrap">Short stats</p>
      ...
      <div className="absolute border border-[#efeff4] border-solid h-[641px] left-[1014px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[343px] w-[350px]" data-name="tool_menu/short_position/inputs">
        <div className="absolute contents left-[-1px] top-[-1px]" data-name="tool_menu/short_position/inputs">
          ...
          <ModalHeaderMBackgroundImageAndText text="Short Position" />
        </div>
      </div>
      <div className="absolute border border-[#efeff4] border-solid h-[528px] left-[1404px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[343px] w-[350px]" data-name="tool_menu/short_position/style">
        <div className="absolute contents left-[-1px] top-[-1px]" data-name="tool_menu/short_position/style">
          ...
          <div className="absolute contents left-[15px] top-[212px]" data-name="target_color">
            <div className="absolute left-[calc(50%+12px)] size-[32px] top-[212px]" data-name="dropdown/color/default">
              ...
              <div className="absolute bg-size-[auto_auto,97.00000286102295px_97.00000286102295px] bg-top-left inset-[12.5%] rounded-[4px]" data-name="color" style={{ backgroundImage: `linear-gradient(90deg, rgba(46, 167, 144, 0.1) 0%, rgba(46, 167, 144, 0.1) 100%), url('${imgColor}')` }} />
            </div>
          ...
          <div className="absolute contents left-[15px] top-[160px]" data-name="stop_color">
            <div className="absolute left-[calc(50%+12px)] size-[32px] top-[160px]" data-name="dropdown/color/default">
              ...
              <div className="absolute bg-size-[auto_auto,97.00000286102295px_97.00000286102295px] bg-top-left inset-[12.5%] rounded-[4px]" data-name="color" style={{ backgroundImage: `linear-gradient(90deg, rgba(241, 109, 96, 0.1) 0%, rgba(241, 109, 96, 0.1) 100%), url('${imgColor}')` }} />
            </div>
          ...
          <div className="absolute contents left-[15px] top-[108px]" data-name="lines">
            ...
            <div className="absolute left-[calc(50%+12px)] size-[32px] top-[108px]" data-name="dropdown/color/default">
              ...
              <div className="absolute bg-[rgba(62,62,62,0.5)] inset-[12.5%] rounded-[2px]" data-name="color" />
            </div>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[126px] overflow-clip top-[1212px] w-[1440px]" data-name="short_position/edit_mode or hover">
        ...
        <div className="absolute contents left-[calc(55.56%-10px)] top-[108px]" data-name="tool_menu_extended/short_position">
          <BackgroundImage5 />
        </div>
        <div className="absolute contents left-[calc(27.78%+31px)] top-[234px]" data-name="short_position">
          ...
          <StopBackgroundImageAndText text="Stop: 53.23 (21.45%) 5323, Amount: 749.98" additionalClassNames="left-[calc(47.22%-14px)] top-[calc(50%-207px)]" />
          <TargetBackgroundImageAndText text="Target: 53.23 (21.45%) 5323, Amount: 1250.02" additionalClassNames="left-[calc(47.22%-14.5px)] top-[calc(50%+230px)]" />
        </div>
      </div>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1659px] overflow-clip top-[1212px] w-[1440px]" data-name="short_position/default">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <ChartBackgroundImage />
        <ToolsBarDefaultBackgroundImage />
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        <IconCryptohopper className="absolute left-[11px] size-[26px] top-[19px]" />
        <div className="absolute contents left-[calc(27.78%+35px)] top-[252px]" data-name="short_position">
          <ShortPositionBackgroundImage />
        </div>
      </div>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[3192px] overflow-clip top-[1212px] w-[1440px]" data-name="short_position/on_chart">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <div className="absolute contents left-0 top-[739px]" data-name="time_line">
            <div className="absolute bg-white h-[33px] left-0 rounded-bl-[6px] rounded-br-[6px] top-[739px] w-[1368px]" data-name="timeline_bg" />
            <div className="absolute bg-[#dcf5f7] h-[32px] left-[572px] opacity-50 top-[740px] w-[125px]" data-name="bg" />
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1265px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">22</p>
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1200px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">19</p>
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1068px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">12</p>
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1001px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">8</p>
            ...
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[78px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">20</p>
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[12px] not-italic text-[#8e8e93] text-[12px] text-center top-[749px] whitespace-nowrap">17</p>
            <div className="absolute contents left-[540px] top-[740px]" data-name="date">
              <div className="absolute contents left-[540px] top-[740px]" data-name="cursor_date">
                <div className="absolute bg-[#00b1c7] h-[19px] left-[540px] top-[740px] w-[65px]" data-name="card_bg" />
                <div className="absolute flex h-[4px] items-center justify-center left-[572px] top-[740px] w-[0.5px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
                  <div className="-rotate-90 flex-none">
                    <div className="bg-white h-[0.5px] w-[4px]" data-name="indicator" />
                  </div>
                </div>
                <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[547px] not-italic text-[12px] text-white top-[742px] whitespace-nowrap">15 Sep, 20</p>
              </div>
            </div>
          </div>
          <div className="absolute contents left-0 top-0" data-name="righst_side_bar">
            <div className="absolute contents left-0 top-0" data-name="price_bar">
              <div className="absolute bg-white h-[772px] left-[1303px] rounded-br-[6px] rounded-tr-[6px] top-0 w-[65px]" data-name="right_side_bar_bg" />
              <div className="absolute bg-[#dcf5f7] h-[209px] left-[1304px] opacity-50 top-[192px] w-[64px]" data-name="bg" />
              <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1312px] not-italic text-[#8e8e93] text-[12px] top-[75px] whitespace-nowrap">13200.00</p>
              <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1312px] not-italic text-[#8e8e93] text-[12px] top-[40px] whitespace-nowrap">13400.00</p>
              <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1312px] not-italic text-[#8e8e93] text-[12px] top-[145px] whitespace-nowrap">12800.00</p>
              <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1312px] not-italic text-[#8e8e93] text-[12px] top-[110px] whitespace-nowrap">13000.00</p>
          ...
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <LogoCryptohopperExtended className="absolute h-[38px] left-[18px] top-[683px] w-[169px]" />
            <div className="absolute contents left-[421px] top-[174px]" data-name="short_position">
              <div className="absolute contents left-[425px] top-[192px]" data-name="short_position">
                <div className="absolute bg-[rgba(255,107,92,0.1)] h-[209px] left-[425px] top-[192px] w-[461px]" data-name="bg_red" />
                <BackgroundImage9 additionalClassNames="left-[425px] top-[401px]" />
                <div className="absolute bg-[rgba(9,151,126,0.1)] h-[209px] left-[425px] top-[402px] w-[461px]" data-name="bg_green" />
              </div>
              <MarkerBackgroundImage additionalClassNames="left-[421px] top-[188px]" />
              <MarkerBackgroundImage additionalClassNames="left-[421px] top-[397.5px]" />
              <MarkerBackgroundImage additionalClassNames="left-[882px] top-[397.5px]" />
              <MarkerBackgroundImage additionalClassNames="left-[421px] top-[607px]" />
              <div className="absolute h-[209px] left-[572px] top-[192px] w-[125px]" data-name="vector">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 125 209">
                  <g id="vector">
                    <rect fill="var(--fill-0, #FF6B5C)" fillOpacity="0.2" height="209" id="bg_red" width="125" y="0.000130501" />
                    <path d={svgPaths.p1e9e8000} fill="var(--stroke-0, #8E8E93)" id="vector_2" />
                  </g>
                </svg>
              </div>
              <LabelBackgroundImageAndText text="Risk/Reward Ratio: 1" additionalClassNames="left-[calc(50%+4px)] top-[calc(50%+31.5px)]" />
              <StopBackgroundImageAndText text="Stop: 53.23 (21.45%) 5323, Amount: 749.98" additionalClassNames="left-[calc(50%+4.5px)] top-[calc(50%-186.5px)]" />
              <TargetBackgroundImageAndText text="Target: 53.23 (21.45%) 5323, Amount: 1250.02" additionalClassNames="left-[calc(50%+4px)] top-[calc(50%+250.5px)]" />
            </div>
          </div>
        ...
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        <IconCryptohopper className="absolute left-[11px] size-[26px] top-[19px]" />
        <div className="absolute contents left-[60px] top-[490px]" data-name="actual_price">
          <div className="absolute flex h-px items-center justify-center left-[60px] top-[499px] w-[1305px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
              <div className="border border-[#f26d60] border-dashed h-[1305px] w-px" data-name="trend_line" />
            </div>
          </div>
          <div className="absolute contents left-[calc(94.44%+4px)] top-[509px]" data-name="time">
            <div className="absolute contents left-[calc(94.44%+4px)] top-[509px]" data-name="card">
              <div className="absolute bg-white h-[19px] left-[calc(94.44%+4px)] top-[509px] w-[64px]" data-name="time_card_bg" />
              <div className="absolute bg-[rgba(255,107,92,0.1)] h-[19px] left-[calc(94.44%+4px)] top-[509px] w-[64px]" data-name="time_card_bg" />
            </div>
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[calc(100%-68px)] not-italic text-[#f26d60] text-[12px] top-[511px] whitespace-nowrap">09: 12: 32</p>
          </div>
          <div className="absolute contents left-[calc(94.44%+4px)] top-[490px]" data-name="price_actual">
            <div className="absolute bg-[#f26d60] h-[19px] left-[calc(94.44%+4px)] top-[490px] w-[64px]" data-name="card_bg" />
            <div className="absolute bg-white h-px left-[calc(94.44%+4px)] top-[499px] w-[4px]" data-name="indicator_line" />
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[calc(100%-68px)] not-italic text-[12px] text-white top-[492px] whitespace-nowrap">11194.00</p>
          </div>
        </div>
        <div className="absolute contents left-[calc(94.44%+4px)] top-[247px]" data-name="price">
          <div className="absolute contents left-[calc(94.44%+4px)] top-[247px]" data-name="price">
            <div className="absolute bg-[#00b1c7] h-[19px] left-[calc(94.44%+4px)] top-[247px] w-[64px]" data-name="card_bg" />
            <div className="absolute bg-white h-px left-[calc(94.44%+4px)] top-[256px] w-[4px]" data-name="indicator_line" />
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[calc(100%-68px)] not-italic text-[12px] text-white top-[249px] whitespace-nowrap">11650.00</p>
          </div>
          <div className="absolute contents left-[calc(94.44%+4px)] top-[455px]" data-name="price">
            <div className="absolute bg-[#00b1c7] h-[19px] left-[calc(94.44%+4px)] top-[455px] w-[64px]" data-name="card_bg" />
            <div className="absolute bg-white h-px left-[calc(94.44%+4px)] top-[464px] w-[4px]" data-name="indicator_line" />
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[calc(100%-68px)] not-italic text-[12px] text-white top-[457px] whitespace-nowrap">11390.00</p>
          </div>
        </div>
        <div className="absolute contents left-[calc(55.56%-10px)] top-[108px]" data-name="tool_menu_extended/short_position">
          <BackgroundImage5 />
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1656px] overflow-clip top-[2421px] w-[1440px]" data-name="short_position/short_stats">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <ChartBackgroundImage />
        <ToolsBarDefaultBackgroundImage />
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        ...
        <div className="absolute contents left-[calc(27.78%+31px)] top-[234px]" data-name="short_position">
          ...
          <MarkerBackgroundImage additionalClassNames="left-[calc(61.11%+12px)] top-[457.5px]" />
          <MarkerBackgroundImage additionalClassNames="left-[calc(27.78%+31px)] top-[667px]" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f26d60] content-stretch flex items-center left-[calc(47.22%-14.5px)] px-[10px] py-[2px] rounded-[4px] top-[calc(50%+11px)]" data-name="label">
            <div aria-hidden="true" className="absolute border border-[#f6877c] border-solid inset-0 pointer-events-none rounded-[4px]" />
            <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
              <p className="mb-0">-11.70 ~ 4.554</p>
              <p>1.17</p>
            </div>
          </div>
          <StopBackgroundImageAndText text="54.90 (14.24%) 749.99" additionalClassNames="left-[calc(47.22%-14px)] top-[calc(50%-207px)]" />
          <TargetBackgroundImageAndText text="64.18 (16.65%) 1292.28" additionalClassNames="left-[calc(47.22%-14.5px)] top-[calc(50%+230px)]" />
        </div>
      </div>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[124px] overflow-clip top-[2421px] w-[1440px]" data-name="short_position/raised">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <ChartBackgroundImage />
        <ToolsBarDefaultBackgroundImage />
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        ...
        <div className="absolute contents left-[calc(27.78%+31px)] top-[234px]" data-name="short_position">
          <div className="absolute contents left-[calc(27.78%+35px)] top-[252px]" data-name="short_position">
            <div className="absolute bg-[rgba(255,107,92,0.1)] h-[88px] left-[calc(27.78%+35px)] top-[252px] w-[461px]" data-name="bg_red" />
            <BackgroundImage9 additionalClassNames="left-[calc(27.78%+35px)] top-[340px]" />
            <div className="absolute bg-[rgba(9,151,126,0.1)] h-[331px] left-[calc(27.78%+35px)] top-[340px] w-[461px]" data-name="bg_green" />
          </div>
          <MarkerBackgroundImage additionalClassNames="left-[calc(27.78%+31px)] top-[248px]" />
          <MarkerBackgroundImage additionalClassNames="left-[calc(27.78%+31px)] top-[336.5px]" />
          <MarkerBackgroundImage additionalClassNames="left-[calc(61.11%+12px)] top-[336.5px]" />
          <MarkerBackgroundImage additionalClassNames="left-[calc(27.78%+31px)] top-[667px]" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#09977e] content-stretch flex items-center left-[calc(47.22%-16.5px)] px-[10px] py-[2px] rounded-[4px] top-[calc(50%-110px)]" data-name="label">
            <div aria-hidden="true" className="absolute border border-[#15aa90] border-solid inset-0 pointer-events-none rounded-[4px]" />
            <div className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
              <p className="mb-0">{`Open P&L: 150.86, Qty: 4.697`}</p>
              <p>Risk/Reward Ratio: 4.3</p>
            </div>
          </div>
          <StopBackgroundImageAndText text="Stop: 53.23 (21.45%) 5323, Amount: 749.98" additionalClassNames="left-[calc(47.22%-14px)] top-[calc(50%-207px)]" />
          <TargetBackgroundImageAndText text="Target: 53.23 (21.45%) 5323, Amount: 1250.02" additionalClassNames="left-[calc(47.22%-14.5px)] top-[calc(50%+230px)]" />
      ...
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[133px] not-italic text-[20px] text-black top-[281px] whitespace-nowrap">Menus</p>
      <div className="absolute contents left-[133px] top-[378px]" data-name="tool_menu_extended/short_position">
        <div className="absolute bg-white content-stretch flex items-center left-[133px] py-px rounded-[6px] top-[378px]">
          <div aria-hidden="true" className="absolute border border-[#efeff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)]" />
          <IconsDragBackgroundImage />
          <BackgroundImage8 />
          <MenuItemTextColorBackgroundImage />
      ...
      <div className="absolute contents left-[133px] top-[329px]" data-name="tool_menu/short_position">
        <div className="absolute bg-white content-stretch flex items-center left-[133px] py-px rounded-[6px] top-[329px]">
      ...
      <div className="absolute contents left-[314px] right-[4286px] top-[436px]" data-name="tool_menu/layers">
        <div className="absolute bg-white border border-[#efeff4] border-solid h-[150px] left-[314px] right-[4286px] rounded-[4px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)] top-[436px]" data-name="bg" />
        <ListItem32SBackgroundImageAndText text="Bring to Front" additionalClassNames="left-[315px] right-[4287px] top-[444px]" />
        <div className="absolute h-[32px] left-[315px] right-[4287px] top-[478px]" data-name="list_item_32/S">
        ...
        <ListItem32SBackgroundImageAndText text="Bring Forward" additionalClassNames="left-[315px] right-[4287px] top-[512px]" />
        <ListItem32SBackgroundImageAndText text="Send Backwards" additionalClassNames="left-[315px] right-[4287px] top-[546px]" />
      </div>
      <div className="absolute contents left-[444px] top-[436px]" data-name="tool_menu/copy">
        <div className="absolute bg-white border border-[#efeff4] border-solid h-[80px] left-[444px] right-[4210px] rounded-[4px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)] top-[436px]" data-name="bg" />
        <ListItem32SBackgroundImageAndText text="Copy" additionalClassNames="left-[445px] top-[444px] w-[64px]" />
        <ListItem32SBackgroundImageAndText text="Clone" additionalClassNames="left-[445px] top-[476px] w-[64px]" />
      </div>
      <div className="absolute h-[252px] left-[138px] top-[436px] w-[164px]" data-name="tool_menu/color">
      ...
      <div className="absolute h-[296px] left-[1794px] top-[513px] w-[103px]" data-name="tool_menu/font_size">
        ...
        <ShortPositionFontSizeBackgroundImageAndText text="16" additionalClassNames="bottom-1/2 top-[40.54%]" />
        <ShortPositionFontSizeBackgroundImageAndText text="20" additionalClassNames="bottom-[40.54%] top-1/2" />
      ...
      <div className="absolute h-[48px] left-[1794px] top-[447px] w-[159px]" data-name="line_menu/line_width">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-0 rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
      ...
      <div className="absolute contents inset-[27.9%_76.57%_69.88%_21.53%]" data-name="dropdown/precision">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[27.9%_76.57%_69.88%_21.53%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <div className="absolute inset-[28.12%_76.58%_70.99%_21.54%]" data-name="list_item/32/centered">
          <div className="absolute bg-[#f8f8ff] h-[32px] left-0 right-0 top-0" data-name="bg" />
        ...
        <div className="absolute inset-[29.01%_76.58%_70.1%_21.54%]" data-name="list_item/32/centered">
          <div className="absolute bg-white h-[32px] left-0 right-0 top-0" data-name="bg" />
      ...
      <div className="absolute left-[3027px] size-[32px] top-[554px]" data-name="dropdown/color/default">
        <div className="absolute flex inset-0 items-center justify-center">
          <BackgroundImage1 additionalClassNames="size-[32px]" />
        </div>
        <div className="absolute bg-[#00b1c7] inset-[12.5%] rounded-[4px]" data-name="color" />
      </div>
      <div className="absolute contents left-[2398px] top-[344px]">
        <div className="absolute contents left-[2455px] top-[395px]" data-name="thickness">
          <div className="absolute left-[2455px] overflow-clip size-[24px] top-[395px]" data-name="icons/small_chevron/down" />
        </div>
        <div className="absolute contents left-[2398px] top-[344px]" data-name="tooltip">
          <BackgroundImage13 additionalClassNames="left-[calc(50%+108.5px)] top-[calc(50%-1440px)]">{`Line Thickness & Style`}</BackgroundImage13>
          <BackgroundImage10 additionalClassNames="inset-[10.42%_47.54%_89.39%_52.16%]" />
        </div>
      </div>
      <Icon className="absolute h-[38px] left-[2577px] top-[388px] w-[56px]" />
      <div className="absolute contents left-[2569px] top-[344px]" data-name="tooltip">
        <BackgroundImageAndText text="Settings" additionalClassNames="left-[2569px]" />
        <BackgroundImage10 additionalClassNames="inset-[10.42%_44.68%_89.39%_55.02%]" />
      </div>
      <MenuItemIconDefault className="absolute h-[38px] left-[2705px] top-[388px] w-[66px]" />
      <div className="absolute contents left-[2692px] top-[344px]" data-name="tooltip">
        <BackgroundImageAndText text="Visual Order" additionalClassNames="left-[2692px]" />
        <BackgroundImage10 additionalClassNames="inset-[10.42%_41.86%_89.39%_57.84%]" />
      </div>
      <MenuItemIconDefault className="absolute h-[38px] left-[2841px] top-[388px] w-[66px]" />
      <div className="absolute contents left-[2829px] top-[344px]" data-name="tooltip">
        <TooltipBackgroundImageAndText1 text="Clone, Copy" additionalClassNames="left-[2829px] top-[344px]" />
        <BackgroundImage10 additionalClassNames="inset-[10.42%_38.96%_89.39%_60.74%]" />
      </div>
      <div className="absolute h-[38px] left-[3063px] top-[388px] w-[56px]" data-name="delete">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <IconsRemoveSmall className="absolute inset-[18.42%_28.57%] overflow-clip" />
      </div>
      <div className="absolute contents left-[3055px] top-[344px]" data-name="tooltip">
        <TooltipBackgroundImageAndText1 text="Remove" additionalClassNames="left-[3055px] top-[344px]" />
        <BackgroundImage10 additionalClassNames="inset-[10.42%_34.39%_89.39%_65.32%]" />
      </div>
      <div className="absolute h-[38px] left-[2961px] top-[388px] w-[56px]" data-name="lock">
        <div className="absolute bg-white inset-0" data-name="bg" />
      ...
      <div className="absolute contents left-[2962px] top-[344px]" data-name="tooltip">
        <TooltipBackgroundImageAndText1 text="Lock" additionalClassNames="left-[2962px] top-[344px]" />
        <BackgroundImage10 additionalClassNames="inset-[10.42%_36.53%_89.39%_63.18%]" />
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[2398px] not-italic text-[20px] text-black top-[293px] whitespace-nowrap">Tooltips</p>
      <DropdownWidthStyleDefault className="absolute h-[32px] left-[2438px] top-[432px] w-[62px]" />
      <div className="absolute h-[38px] left-[2438px] top-[388px] w-[62px]" data-name="menu_item/width_style/solid_1">
        <div className="absolute bg-white inset-0" data-name="bg" />
      ...
      <div className="absolute contents left-[2648px] top-[504px]" data-name="tooltip">
        <BackgroundImage13 additionalClassNames="left-[calc(50%+352.5px)] top-[calc(50%-1280px)]">Background Color 1</BackgroundImage13>
        <BackgroundImage10 additionalClassNames="inset-[14.87%_42.39%_84.94%_57.31%]" />
      </div>
      <div className="absolute contents left-[2800px] top-[504px]" data-name="tooltip">
        <TooltipBackgroundImage additionalClassNames="left-[calc(50%+505.5px)]">{`Background Color  2`}</TooltipBackgroundImage>
        <BackgroundImage10 additionalClassNames="inset-[14.87%_39.15%_84.94%_60.55%]" />
      </div>
      <div className="absolute contents left-[2982px] top-[504px]" data-name="tooltip">
        <TooltipBackgroundImage additionalClassNames="left-[calc(50%+682.5px)]">{`Background Color  `}</TooltipBackgroundImage>
        <BackgroundImage10 additionalClassNames="inset-[14.87%_35.38%_84.94%_64.32%]" />
      </div>
      <div className="absolute h-[38px] left-[2689px] top-[548px] w-[48px]" data-name="menu_item/bg_color">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <div className="absolute bg-[rgba(255,107,92,0.1)] bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" />
        <IconsBackgroundColor className="absolute bottom-[18.42%] left-1/4 right-1/4 top-[18.42%]" />
      </div>
      <div className="absolute h-[38px] left-[2842px] top-[548px] w-[48px]" data-name="menu_item/bg_color">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <div className="absolute bg-[rgba(0,177,199,0.1)] bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" />
        <IconsBackgroundColor className="absolute bottom-[18.42%] left-1/4 right-1/4 top-[18.42%]" />
      </div>
      <div className="absolute contents left-[3141px] top-[505px]" data-name="tooltip">
        <TooltipBackgroundImageAndText1 text="Text Size" additionalClassNames="left-[3141px] top-[505px]" />
        <BackgroundImage10 additionalClassNames="inset-[14.89%_32.52%_84.91%_67.18%]" />
      </div>
      <div className="absolute contents left-[2394px] top-[505px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Text Color" additionalClassNames="left-[2394px]" />
        <BackgroundImage10 additionalClassNames="inset-[14.89%_48.28%_84.91%_51.42%]" />
      </div>
      <div className="absolute contents left-[2526px] top-[505px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Line Color" additionalClassNames="left-[2526px]" />
        <BackgroundImage10 additionalClassNames="inset-[14.89%_45.49%_84.91%_54.22%]" />
      </div>
      <div className="absolute h-[38px] left-[2543px] top-[549px] w-[48px]" data-name="menu_item/line_color">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <div className="absolute bg-[#3e3e3e] bottom-1/2 left-1/4 right-1/4 rounded-[6px] top-[47.37%]" data-name="thickness" />
        <div className="absolute bg-[#222268] bottom-[7.89%] left-1/4 right-1/4 rounded-[1px] top-[81.58%]" data-name="color" />
      </div>
      <div className="absolute h-[38px] left-[2410px] top-[549px] w-[48px]" data-name="menu_item/text_color">
        <div className="absolute bg-white inset-0" data-name="bg" />
      ...
      <div className="absolute h-[38px] left-[3147px] top-[549px] w-[62px]" data-name="menu_item/font_size/default">
        <div className="absolute bg-white inset-0" data-name="bg" />
