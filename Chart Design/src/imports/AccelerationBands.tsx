...
import svgPaths from "./svg-i2tzuh4pwl";
...
function BackgroundImage5({ children }: React.PropsWithChildren<{}>) {
  return (
    <svg fill="none" preserveAspectRatio="none" viewBox="0 0 1306.99 621.065" className="absolute block size-full">
      <g id="acceleration_bands">{children}</g>
    </svg>
  );
}
...
function DropdownColorDefaultBackgroundImage({ additionalClassNames = "" }: DropdownColorDefaultBackgroundImageProps) {
  return (
    <div className={clsx("absolute left-[calc(33.33%+12.67px)] size-[32px]", additionalClassNames)}>
...
function ModalHeaderLBackgroundImageAndText({ text, additionalClassNames = "" }: ModalHeaderLBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[41px] w-[406px]", additionalClassNames)}>
...
type InputMFilledBackgroundImageAndTextProps = {
  text: string;
  additionalClassNames?: string;
};

function InputMFilledBackgroundImageAndText({ text, additionalClassNames = "" }: InputMFilledBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[32px] left-[calc(33.33%+12.67px)] w-[109px]", additionalClassNames)}>
      <div className="absolute flex h-[32px] items-center justify-center left-0 right-0 top-0">
        <BackgroundImage4 additionalClassNames="h-[109px] w-[32px]" />
      </div>
...
function LayersBackgroundImage() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <BackgroundImage />
      <IndicatorMenuItemDropdownDefault className="col-1 h-[30px] ml-px mt-0 relative row-1 w-[60px]" />
    </div>
  );
}

function ConfigurationBackgroundImage() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <BackgroundImage />
...
function AccelerationBandsBackgroundImage() {
  return (
    <div className="absolute h-[620px] left-[-0.5px] top-[52.5px] w-[1306.5px]">
      <BackgroundImage5>
        <path d={svgPaths.p2de17c00} id="Vector 25" stroke="var(--stroke-0, #F6877C)" />
        <path d={svgPaths.p4b67300} id="Vector 26" stroke="var(--stroke-0, #44BAF1)" />
        <path d={svgPaths.p298af680} id="Vector 27" stroke="var(--stroke-0, #F6877C)" />
      </BackgroundImage5>
    </div>
  );
}
type IndicatorMenuShortBackgroundImageProps = {
  additionalClassNames?: string;
};

function IndicatorMenuShortBackgroundImage({ additionalClassNames = "" }: IndicatorMenuShortBackgroundImageProps) {
  return (
    <div className={clsx("absolute bg-white content-stretch flex items-center px-[12px] py-[8px] rounded-[6px]", additionalClassNames)}>
      ...
      <NameBackgroundImage text="ABands" text1="200.001" text2="close" />
    </div>
  );
}
...
function NameBackgroundImage({ text, text1, text2 }: NameBackgroundImageProps) {
  return (
    <div className="content-stretch flex gap-[6px] items-center leading-[normal] not-italic relative shrink-0 text-[#1f1f1f] text-[12px] whitespace-nowrap">
      <p className="font-['Source_Sans_Pro:Bold',sans-serif] relative shrink-0">{text}</p>
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] relative shrink-0">{text1}</p>
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] relative shrink-0">{text2}</p>
    </div>
  );
}
type CoordinatesBackgroundImageProps = {
  text: string;
  text1: string;
  text2: string;
  additionalClassNames?: string;
...
function CoordinatesBackgroundImage({ text, text1, text2, additionalClassNames = "" }: CoordinatesBackgroundImageProps) {
  return (
    <div className={clsx("absolute bg-white content-stretch flex font-['Source_Sans_Pro:Regular',sans-serif] gap-[8px] items-center leading-[normal] not-italic py-[8px] text-[12px] whitespace-nowrap", additionalClassNames)}>
      <p className="relative shrink-0 text-[#f6877c]">{text}</p>
      <p className="relative shrink-0 text-[#44baf1]">{text1}</p>
      <p className="relative shrink-0 text-[#f6877c]">{text2}</p>
    </div>
  );
}
...
type ToolMenuLayersListItem32SBackgroundImageAndTextProps = {
  text: string;
  additionalClassNames?: string;
};

function ToolMenuLayersListItem32SBackgroundImageAndText({ text, additionalClassNames = "" }: ToolMenuLayersListItem32SBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[32px] left-[125px] right-[3089px]", additionalClassNames)}>
      <div className="absolute bg-white h-[32px] left-0 right-0 top-0" data-name="bg" />
...
type UpperBarDefaultBackgroundImageProps = {
  additionalClassNames?: string;
};

function UpperBarDefaultBackgroundImage({ additionalClassNames = "" }: UpperBarDefaultBackgroundImageProps) {
  return (
    <div className={clsx("absolute flex items-center justify-center", additionalClassNames)}>
...
function DropdownTextIconDefault({ className }: { className?: string }) {
  return (
    <div className={className || "h-[32px] relative w-[125px]"} data-name="dropdown/text+icon/default">
...
function IndicatorMenuItemDropdownDefault({ className }: { className?: string }) {
  return (
    <div className={className || "h-[30px] relative w-[60px]"} data-name="indicator_menu_item/dropdown/default">
      <div className="absolute bg-white inset-0" data-name="bg" />
      <div className="absolute inset-[10%_0_10%_60%] overflow-clip" data-name="icons/small_chevron/down">
        <VectorBackgroundImage additionalClassNames="absolute inset-[45.83%_37.5%_41.67%_37.5%]" />
      </div>
      <div className="absolute inset-[10%_40%_10%_20%] overflow-clip" data-name="icons/layers">
  ...
  return (
    <div className={className || "relative size-[24px]"} data-name="icons/fullscreen">
      <div className="absolute inset-[16.67%]" data-name="Vector">
        <BackgroundImage6 additionalClassNames="inset-[-3.13%]">
  ...
  return (
    <div className={className || "h-[40px] relative w-[1368px]"} data-name="upper_bar/default">
      ...
      <div className="absolute content-stretch flex inset-[0_10.01%_0_62.06%] items-center" data-name="instruments">
        ...
        <div className="h-[40px] relative shrink-0 w-[56px]" data-name="button/menu/default">
          ...
          <div className="absolute inset-[20%_28.57%] overflow-clip" data-name="icons/dark_mode">
            <div className="absolute inset-[16.67%]" data-name="Vector">
              <BackgroundImage6 additionalClassNames="inset-[-3.13%_-3.13%_-3.12%_-3.13%]">
      ...
      <div className="absolute contents inset-[0_66.74%_0_1.46%]" data-name="left_side">
        <UpperBarDefaultBackgroundImage additionalClassNames="inset-[20%_66.74%_20%_33.19%]" />
        <UpperBarDefaultBackgroundImage additionalClassNames="inset-[20%_83.63%_20%_16.3%]" />
        <UpperBarDefaultBackgroundImage additionalClassNames="inset-[20%_90.57%_20%_9.36%]" />
        <UpperBarDefaultBackgroundImage additionalClassNames="inset-[20%_79.9%_20%_20.03%]" />
        <UpperBarDefaultBackgroundImage additionalClassNames="inset-[20%_70.91%_20%_29.02%]" />
    ...
    <div className={className || "relative size-[40px]"} data-name="button/round/default">
      <div className="absolute inset-[-80%_-102.5%_-120%_-97.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 120">
          <g filter="url(#filter0_d_28_5402)" id="round_bg">
            <circle cx="59" cy="52" fill="var(--fill-0, white)" fillOpacity="0.9" r="20" />
            <circle cx="59" cy="52" r="19.5" stroke="var(--stroke-0, #F8F8FF)" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="120" id="filter0_d_28_5402" width="120" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_28_5402" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_28_5402" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
export default function AccelerationBands() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Acceleration_Bands">
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[#00b1c7] text-[103px] top-[110px] whitespace-nowrap">Acceleration Bands</p>
      <div className="absolute h-[30px] left-[1181px] top-[536px] w-[48px]" data-name="indicator_menu_item/button/default">
        <div className="absolute bg-white inset-0" data-name="bg" />
        <IconsRemoveSmall className="absolute bottom-[10%] left-1/4 overflow-clip right-1/4 top-[10%]" />
      </div>
      <div className="absolute contents left-[1054px] top-[493px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Settings" additionalClassNames="left-[calc(50%-576.5px)] top-[calc(50%-1510px)]" />
        <BackgroundImage2 additionalClassNames="inset-[12.98%_67.11%_86.85%_32.47%]" />
      </div>
      <IndicatorMenuItemButtonDefault className="absolute h-[30px] left-[1066px] top-[537px] w-[48px]" />
      <IndicatorMenuItemDropdownDefault className="absolute h-[30px] left-[835px] top-[536px] w-[60px]" />
      <div className="absolute contents left-[1145.5px] top-[492px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Remove Indicator" additionalClassNames="left-[calc(50%-461px)] top-[calc(50%-1511px)]" />
        <BackgroundImage2 additionalClassNames="inset-[12.96%_63.64%_86.87%_35.94%]" />
      </div>
      <div className="absolute contents left-[124px] right-[3088px] top-[618px]" data-name="tool_menu/layers">
        <div className="absolute bg-white border border-[#efeff4] border-solid h-[150px] left-[124px] right-[3088px] rounded-[4px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)] top-[618px]" data-name="bg" />
        <ToolMenuLayersListItem32SBackgroundImageAndText text="Bring to Front" additionalClassNames="top-[626px]" />
        <div className="absolute h-[32px] left-[125px] right-[3089px] top-[660px]" data-name="list_item_32/S">
        ...
        <ToolMenuLayersListItem32SBackgroundImageAndText text="Bring Forward" additionalClassNames="top-[694px]" />
        <ToolMenuLayersListItem32SBackgroundImageAndText text="Send Backwards" additionalClassNames="top-[728px]" />
      </div>
      <div className="absolute contents left-[819px] top-[492px]" data-name="tooltip">
        <div className="absolute bg-[#1f1f1f] content-stretch flex items-center left-[819px] px-[15px] py-[8px] rounded-[3px] top-[492px]" data-name="tooltip">
          <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">Visual Order</p>
        </div>
        <BackgroundImage2 additionalClassNames="inset-[12.96%_73.86%_86.87%_25.72%]" />
      </div>
      <div className="absolute contents left-[947px] top-[492px]" data-name="copy">
        <div className="absolute h-[30px] left-[951px] top-[536px] w-[48px]" data-name="indicator_menu_item/button/default">
          <div className="absolute bg-white inset-0" data-name="bg" />
          <div className="absolute bottom-[10%] left-1/4 overflow-clip right-1/4 top-[10%]" data-name="icons/settings">
            <IconBackgroundImage />
          </div>
        </div>
        <div className="absolute contents left-[947px] top-[492px]" data-name="tooltip">
          <div className="absolute bg-[#1f1f1f] content-stretch flex items-center left-[947px] px-[15px] py-[8px] rounded-[3px] top-[492px]" data-name="tooltip">
          ...
          <BackgroundImage2 additionalClassNames="inset-[12.96%_70.53%_86.87%_29.05%]" />
        </div>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[1555px] whitespace-nowrap">Default</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[2666px] whitespace-nowrap">Filled</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1724px] not-italic text-[70px] text-black top-[1555px] whitespace-nowrap">Menu_on_hover</p>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[125px] overflow-clip top-[1670px] w-[1440px]" data-name="Acceleration Bands_default">
        ...
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          ...
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <CoordinatesBackgroundImage text="281.50" text1="230.90" text2="186.01" additionalClassNames="left-[162px] px-[2px] top-[71px]" />
            <IndicatorMenuShortBackgroundImage additionalClassNames="left-[18px] top-[71px]" />
            <AccelerationBandsBackgroundImage />
          </div>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1724px] overflow-clip top-[1670px] w-[1440px]" data-name="Acceleration Bands_default">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <TimeLineBackgroundImage text="22" text1="19" text2="12" text3="8" text4="5" text5="15" text6="Oct" text7="28" text8="24" text9="21" text10="17" text11="14" text12="10" text13="7" text14="4" text15="Sep" text16="27" text17="24" text18="20" text19="17" />
          <RighstSideBarBackgroundImage />
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <LogoCryptohopperExtended className="absolute h-[38px] left-[18px] top-[683px] w-[169px]" />
            <ButtonRoundDefault className="absolute left-[1245px] size-[40px] top-[681px]" />
            <CoordinatesBackgroundImage text="281.50" text1="230.90" text2="186.01" additionalClassNames="left-[158px] top-[71px]" />
            <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[18px] px-[12px] py-px rounded-[6px] top-[71px]" data-name="indicator_menu/extended">
              ...
              <div className="content-stretch flex items-center leading-[0] relative shrink-0" data-name="tools">
                <ConfigurationBackgroundImage />
                <LayersBackgroundImage />
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[125px] overflow-clip top-[2771px] w-[1440px]" data-name="Acceleration Bands_filled">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <TimeLineBackgroundImage text="22" text1="19" text2="12" text3="8" text4="5" text5="15" text6="Oct" text7="28" text8="24" text9="21" text10="17" text11="14" text12="10" text13="7" text14="4" text15="Sep" text16="27" text17="24" text18="20" text19="17" />
          <RighstSideBarBackgroundImage />
          <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]" data-name="chart_items">
            ...
            <ButtonRoundDefault className="absolute left-[1245px] size-[40px] top-[681px]" />
            <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[18px] px-[12px] py-px rounded-[6px] top-[71px]" data-name="indicator_menu/extended">
              <div aria-hidden="true" className="absolute border border-[#f8f8ff] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[1px_8px_40px_0px_rgba(49,49,49,0.06)]" />
              <NameBackgroundImage text="ABands" text1="200.001" text2="close" />
              <div className="content-stretch flex items-center leading-[0] relative shrink-0" data-name="tools">
                <ConfigurationBackgroundImage />
                <LayersBackgroundImage />
            ...
            <div className="absolute h-[621.065px] left-[-0.86px] top-[51.93px] w-[1306.857px]" data-name="acceleration_bands">
              <BackgroundImage5>
                <path d={svgPaths.p34527b00} id="Vector 26" stroke="var(--stroke-0, #44BAF1)" />
                <g id="Union">
                  <path d={svgPaths.p10ab6ff0} fill="var(--fill-0, #F6877C)" />
                  <path d={svgPaths.p2bab2100} fill="var(--fill-0, #F6877C)" />
                </g>
                <g id="Union_2" opacity="0.1">
                  <path d={svgPaths.p12ba2300} fill="var(--fill-0, #F6877C)" />
                  <path d={svgPaths.p19c059f0} fill="var(--fill-0, #F6877C)" />
                  <path d={svgPaths.p2bc9300} fill="var(--fill-0, #F6877C)" />
                </g>
              </BackgroundImage5>
            </div>
          </div>
      ...
      <CoordinatesBackgroundImage text="281.50" text1="230.90" text2="186.01" additionalClassNames="left-[269px] px-[2px] top-[483px]" />
      <IndicatorMenuShortBackgroundImage additionalClassNames="left-[125px] top-[483px]" />
      <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[125px] px-[12px] py-px rounded-[6px] top-[534px]" data-name="indicator_menu/extended">
        <div aria-hidden="true" className="absolute border border-[#efeff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)]" />
        <NameBackgroundImage text="ABands" text1="200.001" text2="close" />
        <div className="content-stretch flex items-center leading-[0] relative shrink-0" data-name="tools">
          <ConfigurationBackgroundImage />
      ...
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1724px] not-italic text-[70px] text-black top-[349px] whitespace-nowrap">Settings</p>
      <div className="absolute h-[271px] left-[2227px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[475px] w-[406px]" data-name="indicator_menu/AB/inputs">
        <div className="absolute bg-white h-[271px] left-0 rounded-[6px] shadow-[1px_8px_40px_0px_rgba(49,49,49,0.06)] top-0 w-[406px]" data-name="bg_modal" />
        <div className="absolute contents left-[15px] top-[224px]" data-name="buttons">
        ...
        <div className="absolute contents left-[15px] top-[160px]" data-name="option">
          <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[166px] whitespace-nowrap">Length</p>
          <InputMFilledBackgroundImageAndText text="20" additionalClassNames="top-[160px]" />
        </div>
        <div className="absolute contents left-[15px] top-[108px]" data-name="option">
          <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[114px] whitespace-nowrap">Factor</p>
          <InputMFilledBackgroundImageAndText text="0.001" additionalClassNames="top-[108px]" />
        </div>
        ...
        <ModalHeaderLBackgroundImageAndText text="Acceleration Bands" additionalClassNames="left-0 top-0" />
      </div>
      <div className="absolute border border-[#efeff4] border-solid h-[396px] left-[1724px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[475px] w-[406px]" data-name="indicator_menu/Acceleration Bands/style">
        <div className="absolute bg-white left-[-1px] rounded-[6px] size-[406px] top-[-1px]" data-name="bg_modal" />
        <div className="absolute contents left-[14px] top-[348px]" data-name="buttons">
          <ButtonSecondarySDefault className="absolute h-[32px] left-[calc(50%+13px)] top-[349px] w-[80px]" />
          <ButtonSPrimaryDefault className="absolute h-[32px] left-[calc(66.67%+40.33px)] top-[349px] w-[80px]" />
          <ButtonTextDefaultBackgroundImageAndText text="Reset Settings" additionalClassNames="top-[356px]" />
        </div>
        <div className="absolute contents left-[14px] top-[284px]" data-name="option">
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[292px] whitespace-nowrap">Precision</p>
          <div className="absolute h-[32px] left-[calc(33.33%+12.67px)] top-[285px] w-[137px]" data-name="dropdown/text_centered/short/default">
            <div className="absolute bg-white border border-[#efeff4] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
            <IconsSmallChevronDownBackgroundImage />
        ...
        <div className="absolute bg-[#efeff4] h-px left-[14px] rounded-[6px] top-[263px] w-[376px]" data-name="divider" />
        <div className="absolute contents left-[14px] top-[107px]" data-name="option">
          <DropdownColorDefaultBackgroundImage additionalClassNames="top-[108px]" />
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[115px] whitespace-nowrap">Upper Band</p>
          <CheckboxLChecked className="absolute left-[15px] size-[24px] top-[112px]" />
          <DropdownWidthStyleDefault className="absolute h-[32px] left-[calc(50%-11px)] top-[108px] w-[93px]" />
          <DropdownTextIconDefault className="absolute h-[32px] left-[calc(66.67%+26.33px)] top-[108px] w-[94px]" />
        </div>
        <div className="absolute contents left-[14px] top-[159px]" data-name="option">
          <div className="absolute left-[calc(33.33%+12.67px)] size-[32px] top-[160px]" data-name="dropdown/color/default">
            ...
            <div className="absolute bg-[#44baf1] inset-[12.5%] rounded-[2px]" data-name="color" />
          </div>
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[167px] whitespace-nowrap">Middle</p>
          <CheckboxLChecked className="absolute left-[15px] size-[24px] top-[164px]" />
          <DropdownWidthStyleDefault className="absolute h-[32px] left-[calc(50%-11px)] top-[160px] w-[93px]" />
          <DropdownTextIconDefault className="absolute h-[32px] left-[calc(66.67%+26.33px)] top-[160px] w-[94px]" />
        </div>
        <div className="absolute contents left-[14px] top-[211px]" data-name="option">
          <DropdownColorDefaultBackgroundImage additionalClassNames="top-[212px]" />
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[219px] whitespace-nowrap">Lower Band</p>
          <CheckboxLChecked className="absolute left-[15px] size-[24px] top-[216px]" />
          <DropdownWidthStyleDefault className="absolute h-[32px] left-[calc(50%-11px)] top-[212px] w-[93px]" />
          <DropdownTextIconDefault className="absolute h-[32px] left-[calc(66.67%+26.33px)] top-[212px] w-[94px]" />
        </div>
        <div className="absolute contents left-[14px] top-[55px]" data-name="tabs">
          ...
          <div className="absolute contents left-[calc(16.67%+9.33px)] top-[57px]" data-name="coordinates">
            <div className="absolute bg-[#00b1c7] inset-[21.97%_73.65%_77.78%_18.97%] rounded-[6px]" data-name="underline" />
        ...
        <ModalHeaderLBackgroundImageAndText text="Acceleration Bands" additionalClassNames="left-[-1px] top-[-1px]" />
      </div>
      <div className="absolute h-[32px] left-[1724px] top-[894px] w-[106px]" data-name="dropdown/text_centered/short/active">
      ...
      <div className="absolute contents inset-[23.04%_45.08%_68.64%_51.74%]" data-name="dropdown/precision">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[23.04%_45.08%_68.64%_51.74%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <div className="absolute inset-[23.24%_45.1%_75.97%_51.76%]" data-name="list_item/32/centered">
          <div className="absolute bg-[#f8f8ff] h-[32px] left-0 right-0 top-0" data-name="bg" />
        ...
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="0" additionalClassNames="inset-[24.03%_45.1%_75.18%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="1" additionalClassNames="inset-[24.82%_45.1%_74.39%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="2" additionalClassNames="inset-[25.61%_45.1%_73.59%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="3" additionalClassNames="inset-[26.41%_45.1%_72.8%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="4" additionalClassNames="inset-[27.2%_45.1%_72.01%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="5" additionalClassNames="inset-[27.99%_45.1%_71.22%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="6" additionalClassNames="inset-[28.78%_45.1%_70.42%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="7" additionalClassNames="inset-[29.58%_45.1%_69.63%_51.76%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="8" additionalClassNames="bg-white inset-[30.37%_45.1%_68.84%_51.76%]" />
      </div>
      <div className="absolute h-[48px] left-[1839px] top-[891px] w-[159px]" data-name="line_menu/line_width">
      ...
      <div className="absolute h-[32px] left-[2010px] top-[890px] w-[125px]" data-name="dropdown/text+icon/active">
        <div className="absolute bg-white border border-[#00b1c7] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
        <IconsSmallChevronUpBackgroundImage />
        <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[35px] not-italic right-[26px] text-[#1f1f1f] text-[14px] top-[6px]">Line</p>
        <IconsLine className="absolute left-[5px] overflow-clip size-[24px] top-[4px]" />
      </div>
      <div className="absolute h-[433px] left-[2010px] top-[926px] w-[179px]" data-name="dropdown_menu/styles">
      ...
      <div className="absolute h-[252px] left-[1519px] top-[897px] w-[164px]" data-name="tool_menu/color">
