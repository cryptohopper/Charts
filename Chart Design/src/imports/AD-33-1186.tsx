...
import svgPaths from "./svg-xznxgldlra";
...
function BackgroundImage8({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute inset-[16.67%]">
      <BackgroundImage9 additionalClassNames="inset-[-3.13%]">{children}</BackgroundImage9>
    </div>
  );
}
...
function VectorBackgroundImage3({ children, additionalClassNames = "" }: React.PropsWithChildren<VectorBackgroundImage3Props>) {
  return (
...
function DropdownResolutionListItem32SBackgroundImageAndText({ text, additionalClassNames = "" }: DropdownResolutionListItem32SBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[32px] left-[2576.01px] w-[136.986px]", additionalClassNames)}>
        ...
        <div className="absolute bottom-[10%] left-1/4 overflow-clip right-1/4 top-[10%]" data-name="icons/settings">
          <div className="absolute flex inset-1/4 items-center justify-center">
            <div className="-scale-y-100 flex-none rotate-90 size-[12px]">
              <VectorBackgroundImage3 additionalClassNames="relative size-full">{children}</VectorBackgroundImage3>
            </div>
          </div>
        </div>
      </div>
...
function VectorBackgroundImage2() {
  return (
    <div className="absolute inset-[17.09%_4.17%_37.94%_-0.07%]">
      <div className="absolute inset-[-0.56%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1311.21 90.5">
          <path d={svgPaths.p15f31200} id="Vector" stroke="var(--stroke-0, #DE5537)" />
        </svg>
      </div>
    </div>
  );
...
function BackgroundImageAndText({ text }: BackgroundImageAndTextProps) {
  return (
    <p className="font-['Source_Sans_Pro:Bold',sans-serif] leading-[0] not-italic relative shrink-0 text-[#1f1f1f] text-[12px] whitespace-nowrap">
      <span className="leading-[normal]">{text}</span>
      <span className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal]">{` `}</span>
    </p>
  );
}
...
function CoordinatesBackgroundImageAndText({ text, additionalClassNames = "" }: CoordinatesBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute bg-white content-stretch flex items-center px-[2px] py-[8px]", additionalClassNames)}>
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#de5537] text-[12px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function NumbersBackgroundImage({ text, text1, text2, text3 }: NumbersBackgroundImageProps) {
  return (
    <div className="absolute contents left-[1302px] top-[-1px]">
      ...
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[118px] whitespace-nowrap">{text1}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[65px] whitespace-nowrap">{text2}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[12px] whitespace-nowrap">{text3}</p>
...
function GridBackgroundImage() {
  return (
    <div className="absolute contents left-[-1px] top-[-1px]">
      ...
      <BackgroundImage4 additionalClassNames="top-[71px]" />
      <BackgroundImage4 additionalClassNames="top-[124px]" />
      ...
      <div className="absolute content-stretch flex inset-[0_10.01%_0_62.06%] items-center" data-name="instruments">
        ...
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="undo_redo">
          ...
          <div className="col-1 ml-[52px] mt-[8px] overflow-clip relative row-1 size-[24px]" data-name="icons/arrow_right">
            <VectorBackgroundImage3 additionalClassNames="absolute inset-1/4">
...
export default function AD() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="A/D">
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[#00b1c7] text-[103px] top-[110px] whitespace-nowrap">A/D</p>
      ...
      <div className="absolute contents left-[816px] top-[493px]" data-name="copy">
        <div className="absolute h-[30px] left-[820px] top-[537px] w-[48px]" data-name="indicator_menu_item/button/default">
          <div className="absolute bg-white inset-0" data-name="bg" />
          <div className="absolute bottom-[10%] left-1/4 overflow-clip right-1/4 top-[10%]" data-name="icons/settings">
            <IconBackgroundImage />
          </div>
        </div>
        <div className="absolute contents left-[816px] top-[493px]" data-name="tooltip">
          <div className="absolute bg-[#1f1f1f] content-stretch flex items-center left-[816px] px-[15px] py-[8px] rounded-[3px] top-[493px]" data-name="tooltip">
          ...
          <BackgroundImage2 additionalClassNames="inset-[18.02%_74.46%_81.74%_25.12%]" />
        </div>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[1567px] whitespace-nowrap">Default</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1724px] not-italic text-[70px] text-black top-[1567px] whitespace-nowrap">Menu_on_hover</p>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[124px] overflow-clip top-[1709px] w-[1440px]" data-name="A/D_default">
        ...
        <div className="absolute bg-white h-[199px] left-[61px] overflow-clip top-[605px] w-[1367px]" data-name="indicator_field">
          ...
          <NumbersBackgroundImage text="500" text1="600" text2="700" text3="800" />
          <BackgroundImage5 />
          <CoordinatesBackgroundImageAndText text="800" additionalClassNames="left-[108px] top-[9px]" />
          <IndicatorMenuShortBackgroundImageAndText text="Accum / Dist" additionalClassNames="left-[17px] top-[9px]" />
        </div>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1724px] overflow-clip top-[1709px] w-[1440px]" data-name="A/D_default">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <div className="absolute h-[772px] left-0 top-0 w-[1368px]" data-name="chart_items">
            <ChartLayoutBackgroundImage />
        ...
        <div className="absolute bg-white h-[199px] left-[61px] overflow-clip top-[605px] w-[1367px]" data-name="indicator_field">
          ...
          <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[17px] px-[12px] py-px rounded-[6px] top-[9px]" data-name="indicator_menu/extended">
            ...
            <div className="content-stretch flex items-center relative shrink-0" data-name="name">
              <BackgroundImageAndText text="Accum / Dist" />
            </div>
      ...
      <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[124px] px-[12px] py-px rounded-[6px] top-[527px]" data-name="indicator_menu/extended">
        <div aria-hidden="true" className="absolute border border-[#efeff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)]" />
        <div className="content-stretch flex items-center relative shrink-0" data-name="name">
          <BackgroundImageAndText text="Accum / Dist" />
        </div>
      ...
      <CoordinatesBackgroundImageAndText text="800" additionalClassNames="left-[215px] top-[485px]" />
      <IndicatorMenuShortBackgroundImageAndText text="Accum / Dist" additionalClassNames="left-[124px] top-[485px]" />
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1724px] not-italic text-[70px] text-black top-[348px] whitespace-nowrap">Settings</p>
      <div className="absolute border border-[#efeff4] border-solid h-[292px] left-[1724px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[465px] w-[406px]" data-name="indicator_menu/AD/style">
        <div className="absolute bg-white h-[292px] left-[-1px] top-[-1px] w-[406px]" data-name="bg_modal" />
        <div className="absolute contents left-[14px] top-[244px]" data-name="buttons">
          <ButtonSecondarySDefault className="absolute h-[32px] left-[calc(50%+13px)] top-[245px] w-[80px]" />
          <ButtonSPrimaryDefault className="absolute h-[32px] left-[calc(66.67%+40.33px)] top-[245px] w-[80px]" />
          <ButtonTextDefaultBackgroundImageAndText text="Reset Settings" additionalClassNames="top-[252px]" />
        </div>
        <div className="absolute contents left-[14px] top-[180px]" data-name="option">
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[188px] whitespace-nowrap">Precision</p>
          <div className="absolute h-[32px] left-[calc(33.33%+12.67px)] top-[181px] w-[137px]" data-name="dropdown/text_centered/short/default">
        ...
        <div className="absolute bg-[#efeff4] h-px left-[14px] rounded-[6px] top-[159px] w-[376px]" data-name="divider" />
        <div className="absolute contents left-[14px] top-[107px]" data-name="option">
          <div className="absolute left-[calc(33.33%+12.67px)] size-[32px] top-[108px]" data-name="dropdown/color/default">
            ...
            <div className="absolute bg-[#de5537] inset-[12.5%] rounded-[2px]" data-name="color" />
          </div>
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[115px] whitespace-nowrap">Acc / Dist</p>
          <div className="absolute left-[15px] size-[24px] top-[112px]" data-name="checkbox/L/checked">
        ...
        <div className="absolute contents left-[14px] top-[55px]" data-name="tabs">
          ...
          <div className="absolute contents left-[calc(16.67%+9.33px)] top-[57px]" data-name="coordinates">
            <div className="absolute bg-[#00b1c7] inset-[29.79%_73.65%_69.86%_18.97%] rounded-[6px]" data-name="underline" />
        ...
        <ModalHeaderLBackgroundImageAndText text="Accumulation / Distribution" />
      </div>
      <div className="absolute border border-[#efeff4] border-solid h-[271px] left-[2308px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[465px] w-[406px]" data-name="indicator_menu/AD/inputs">
        <div className="absolute bg-white h-[271px] left-[-1px] top-[-1px] w-[406px]" data-name="bg_modal" />
      ...
      <div className="absolute h-[48px] left-[1844px] top-[774px] w-[159px]" data-name="line_menu/line_width">
      ...
      <div className="absolute h-[32px] left-[2016px] top-[774px] w-[125px]" data-name="dropdown/text+icon/active">
      ...
      <div className="absolute h-[433px] left-[2016px] top-[810px] w-[179px]" data-name="dropdown_menu/styles">
      ...
      <div className="absolute h-[32px] left-[1725px] top-[774px] w-[106px]" data-name="dropdown/text_centered/short/active">
        <div className="absolute bg-white border border-[#00b1c7] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
        <IconsSmallChevronUpBackgroundImage />
        <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[calc(50%-7px)] not-italic text-[#1f1f1f] text-[14px] text-center top-[calc(50%-10px)] whitespace-nowrap">Values</p>
      </div>
      <div className="absolute contents inset-[28.03%_45.05%_60.42%_51.77%]" data-name="dropdown/precision">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[28.03%_45.05%_60.42%_51.77%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <div className="absolute inset-[28.3%_45.07%_70.6%_51.79%]" data-name="list_item/32/centered">
        ...
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="0" additionalClassNames="inset-[29.4%_45.07%_69.5%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="1" additionalClassNames="inset-[30.5%_45.07%_68.4%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="2" additionalClassNames="inset-[31.6%_45.07%_67.3%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="3" additionalClassNames="inset-[32.7%_45.07%_66.2%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="4" additionalClassNames="inset-[33.8%_45.07%_65.1%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="5" additionalClassNames="inset-[34.9%_45.07%_64%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="6" additionalClassNames="inset-[36%_45.07%_62.9%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="7" additionalClassNames="inset-[37.1%_45.07%_61.8%_51.79%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="8" additionalClassNames="bg-white inset-[38.2%_45.07%_60.69%_51.79%]" />
      </div>
      <div className="absolute h-[32px] left-[2575px] top-[787px] w-[139px]" data-name="dropdown/text_centered/long/active">
        <div className="absolute bg-white border border-[#00b1c7] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
        <IconsSmallChevronUpBackgroundImage />
        <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[calc(50%-10px)] not-italic text-[#1f1f1f] text-[14px] text-center top-[calc(50%-10px)] whitespace-nowrap">Same as symbol</p>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.5] left-[2575px] not-italic text-[16px] text-black top-[754px] whitespace-nowrap">Resolution</p>
      <div className="absolute contents left-[2575px] top-[823px]" data-name="dropdown/resolution">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[28.3%_18.55%_55.74%_77.28%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="Same as symbol" additionalClassNames="top-[831px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 minute" additionalClassNames="top-[863px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="3 minutes" additionalClassNames="top-[895px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="5 minutes" additionalClassNames="top-[927px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="15 minutes" additionalClassNames="top-[959px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="30 minutes" additionalClassNames="top-[991px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="45 minutes" additionalClassNames="top-[1023px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 hour" additionalClassNames="top-[1055px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="2 hours" additionalClassNames="top-[1087px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="3 hours" additionalClassNames="top-[1119px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="4 hours" additionalClassNames="top-[1151px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 day" additionalClassNames="top-[1183px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 week" additionalClassNames="top-[1215px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 month" additionalClassNames="top-[1247px]" />
      </div>
      <div className="absolute h-[252px] left-[1548px] top-[775px] w-[164px]" data-name="tool_menu/color">
        ...
        <div className="absolute contents inset-[5.95%_7.32%_88.49%_7.32%]" data-name="opacity_bar">
          <div className="absolute inset-[7.14%_7.32%_89.68%_7.32%] pointer-events-none rounded-[6px]" data-name="opacity scale">
            <div aria-hidden="true" className="absolute inset-0 rounded-[6px]">
              <div className="absolute bg-size-[13.750000298023224px_13.750000298023224px] bg-top-left inset-0 rounded-[6px]" style={{ backgroundImage: `url('${imgOpacityScale}')` }} />
