...
import svgPaths from "./svg-utwl6toe4u";
...
export default function Rename() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Rename">
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[122px] overflow-clip top-[670px] w-[1440px]" data-name="Share">
        ...
        <div className="absolute contents left-[calc(33.33%+65px)] top-[354px]" data-name="modal/rename_layout">
          ...
          <div className="absolute h-[66px] left-[calc(33.33%+80px)] top-[410px] w-[315px]" data-name="input/L/label/active">
            <div className="absolute contents left-0 right-0 top-[26px]" data-name="input">
              <div className="absolute bg-white border border-[#00b1c7] border-solid h-[40px] left-0 right-0 rounded-[4px] top-[26px]" data-name="input" />
              <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[12px] not-italic text-[#babac1] text-[14px] top-[36px] whitespace-nowrap">&nbsp;</p>
            </div>
            ...
            <div className="absolute bg-[#1f1f1f] h-[18px] left-[12px] top-[37px] w-[0.5px]" />
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[12px] not-italic text-[#babac1] text-[14px] top-[36px] whitespace-nowrap">Unnamed Layout</p>
            <div className="absolute right-[8px] size-[24px] top-[34px]" data-name="button/remove/default">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                <circle cx="12" cy="12" fill="var(--fill-0, #F8F8FF)" id="Ellipse 8" r="12" />
              </svg>
              <div className="absolute inset-[4.17%_0_0_4.17%]" data-name="icons/multiply">
                <div className="absolute inset-[33.33%_37.5%_37.5%_33.33%]" data-name="multiply">
                  <div className="absolute inset-[-7.45%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.70833 7.70834">
                      <g id="multiply">
                        <path d={svgPaths.pdb11400} id="Vector" stroke="var(--stroke-0, #8E8E93)" strokeLinecap="round" strokeLinejoin="round" />
                        <path d={svgPaths.p22b31000} id="Vector_2" stroke="var(--stroke-0, #8E8E93)" strokeLinecap="round" strokeLinejoin="round" />
                      </g>
                    </svg>
                  </div>
                </div>
          ...
          <div className="absolute h-[41px] left-[calc(33.33%+65px)] top-[354px] w-[350px]" data-name="modal_header/M">
            ...
            <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[11px] w-[289px]">Rename Chart Layout</p>
          </div>
        </div>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[120px] not-italic text-[70px] text-black top-[533px] whitespace-nowrap">Rename default</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1638px] not-italic text-[70px] text-black top-[533px] whitespace-nowrap">Rename success</p>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1638px] overflow-clip top-[670px] w-[1440px]" data-name="Share">
        <FooterBarText text="12: 25: 50 (UTC)" />
        <Chart />
        <ToolsBarDefault className="absolute h-[836px] left-0 top-[64px] w-[48px]" />
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        ...
        <div className="absolute contents left-[calc(38.89%+45px)] top-[365px]" data-name="modal/success">
          ...
          <div className="absolute content-stretch flex flex-col gap-[15px] items-start left-[calc(38.89%+60px)] top-[433px]" data-name="button+text">
            <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#1f1f1f] text-[14px] text-center w-[200px]">The layout was renamed to “Unnamed Default”.</p>
      ...
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.5] left-[947px] not-italic text-[16px] text-black top-[343px] whitespace-nowrap">Rename</p>
      <div className="absolute contents left-[105px] top-[114px]" data-name="save_menu">
        ...
        <div className="absolute contents left-[1053px] top-[160px]" data-name="dropdown_save_menu">
          ...
          <div className="absolute h-[40px] left-[1054px] top-[414px] w-[228px]" data-name="list_item_40/L">
            <div className="absolute bg-white h-[40px] left-0 right-0 top-0" data-name="bg" />
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[20px] not-italic text-[#1f1f1f] text-[14px] top-[11px] whitespace-nowrap">Make a copy ...</p>
          </div>
