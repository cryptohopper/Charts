...
import svgPaths from "./svg-dkh6k4izzx";
...
function ModalHeaderLBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute h-[41px] left-[-1px] top-[-1px] w-[406px]">
      ...
      <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[15px] not-italic text-[#1f1f1f] text-[14px] top-[11px] w-[289px]">{children}</p>
...
function BackgroundImage10({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute inset-[16.67%]">
      <BackgroundImage11 additionalClassNames="inset-[-3.13%]">{children}</BackgroundImage11>
    </div>
  );
}
...
function DropdownResolutionListItem32SBackgroundImageAndText({ text, additionalClassNames = "" }: DropdownResolutionListItem32SBackgroundImageAndTextProps) {
  return (
    <div className={clsx("absolute h-[32px] left-[2591.01px] w-[136.986px]", additionalClassNames)}>
...
function BackgroundImage8() {
  return (
    <div className="absolute flex inset-0 items-center justify-center">
      <BackgroundImage9 additionalClassNames="size-[32px]" />
    </div>
  );
}
...
function IndicatorBackgroundImage1() {
  return (
    <div className="absolute inset-[18.59%_0.29%_-18.09%_-4.32%]">
      <div className="absolute inset-[-0.37%_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1422.76 198.798">
          <path d={svgPaths.p1a862120} id="indicator" stroke="var(--stroke-0, #1DA1F2)" />
        </svg>
      </div>
    </div>
  );
...
function IndicatorBackgroundImage() {
  return (
    <div className="absolute inset-[8.79%_3.07%_14.07%_-0.22%]">
      <div className="absolute inset-[-0.33%_0_-0.37%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1328.76 154.571">
          <path d={svgPaths.p345e1b80} id="indicator" stroke="var(--stroke-0, #E92323)" />
        </svg>
      </div>
    </div>
  );
...
function IndicatorMenuShortBackgroundImage({ text, text1, additionalClassNames = "" }: IndicatorMenuShortBackgroundImageProps) {
  return (
    <div className={clsx("absolute bg-white content-stretch flex gap-[6px] items-center px-[12px] py-[8px] rounded-[6px]", additionalClassNames)}>
      ...
      <p className="font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1f1f1f] text-[12px] whitespace-nowrap">{text1}</p>
    </div>
  );
}
...
function CoordinatesBackgroundImage({ text, text1, additionalClassNames = "" }: CoordinatesBackgroundImageProps) {
  return (
    <div className={clsx("absolute bg-white content-stretch flex font-['Source_Sans_Pro:Regular',sans-serif] gap-[8px] items-center leading-[normal] left-[93px] not-italic py-[8px] text-[12px] top-[9px] whitespace-nowrap", additionalClassNames)}>
      <p className="relative shrink-0 text-[#de5537]">{text}</p>
      <p className="relative shrink-0 text-[#1da1f2]">{text1}</p>
    </div>
  );
}
...
function NumbersBackgroundImage({ text, text1, text2, text3, text4, text5 }: NumbersBackgroundImageProps) {
  return (
    <div className="absolute contents left-[1302px] top-[-1px]">
      ...
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[140px] whitespace-nowrap">{text1}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[108px] whitespace-nowrap">{text2}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[76px] whitespace-nowrap">{text3}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[44px] whitespace-nowrap">{text4}</p>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[normal] left-[1310px] not-italic text-[#8e8e93] text-[10px] top-[12px] whitespace-nowrap">{text5}</p>
...
function GridBackgroundImage() {
  return (
    <div className="absolute contents left-[-1px] top-[-1px]">
      <BackgroundImage4 additionalClassNames="top-[18px]" />
      <BackgroundImage4 additionalClassNames="top-[50px]" />
      <BackgroundImage4 additionalClassNames="top-[82px]" />
      <BackgroundImage4 additionalClassNames="top-[114px]" />
      <BackgroundImage4 additionalClassNames="top-[146px]" />
      <BackgroundImage4 additionalClassNames="top-[178px]" />
...
function ChartLayoutBackgroundImage() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <BackgroundImage3 additionalClassNames="top-[40px]" />
      <BackgroundImage3 additionalClassNames="top-[20px]" />
      <BackgroundImage3 additionalClassNames="top-0" />
      <BackgroundImage3 additionalClassNames="top-[80px]" />
      <BackgroundImage3 additionalClassNames="top-[100px]" />
      <BackgroundImage3 additionalClassNames="top-[160px]" />
      <BackgroundImage3 additionalClassNames="top-[200px]" />
      <BackgroundImage3 additionalClassNames="top-[260px]" />
      <BackgroundImage3 additionalClassNames="top-[300px]" />
      <BackgroundImage3 additionalClassNames="top-[360px]" />
      <BackgroundImage3 additionalClassNames="top-[400px]" />
      <BackgroundImage3 additionalClassNames="top-[480px]" />
      <BackgroundImage3 additionalClassNames="top-[520px]" />
      <BackgroundImage3 additionalClassNames="top-[600px]" />
      <BackgroundImage3 additionalClassNames="top-[640px]" />
      <BackgroundImage3 additionalClassNames="top-[140px]" />
      <BackgroundImage3 additionalClassNames="top-[240px]" />
      <BackgroundImage3 additionalClassNames="top-[320px]" />
      <BackgroundImage3 additionalClassNames="top-[440px]" />
      <BackgroundImage3 additionalClassNames="top-[560px]" />
      <BackgroundImage3 additionalClassNames="top-[680px]" />
      <BackgroundImage3 additionalClassNames="top-[720px]" />
      <BackgroundImage3 additionalClassNames="top-[700px]" />
      <BackgroundImage3 additionalClassNames="top-[660px]" />
      <BackgroundImage3 additionalClassNames="top-[620px]" />
      <BackgroundImage3 additionalClassNames="top-[580px]" />
      <BackgroundImage3 additionalClassNames="top-[500px]" />
      <BackgroundImage3 additionalClassNames="top-[460px]" />
      <BackgroundImage3 additionalClassNames="top-[420px]" />
      <BackgroundImage3 additionalClassNames="top-[380px]" />
      <BackgroundImage3 additionalClassNames="top-[340px]" />
      <BackgroundImage3 additionalClassNames="top-[280px]" />
      <BackgroundImage3 additionalClassNames="top-[220px]" />
      <BackgroundImage3 additionalClassNames="top-[180px]" />
      <BackgroundImage3 additionalClassNames="top-[120px]" />
      <BackgroundImage3 additionalClassNames="top-[60px]" />
    ...
    <div className={className || "relative size-[40px]"} data-name="button/round/default">
      <div className="absolute inset-[-80%_-102.5%_-120%_-97.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 120">
          <g filter="url(#filter0_d_33_2436)" id="round_bg">
            <circle cx="59" cy="52" fill="var(--fill-0, white)" fillOpacity="0.9" r="20" />
            <circle cx="59" cy="52" r="19.5" stroke="var(--stroke-0, #F8F8FF)" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="120" id="filter0_d_33_2436" width="120" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_33_2436" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_33_2436" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
        ...
        <div className="h-[40px] relative shrink-0 w-[56px]" data-name="button/menu/default">
          ...
          <div className="absolute inset-[20%_28.57%] overflow-clip" data-name="icons/dark_mode">
            <div className="absolute inset-[16.67%]" data-name="Vector">
              <BackgroundImage11 additionalClassNames="inset-[-3.13%_-3.13%_-3.12%_-3.13%]">
...
export default function Aroon() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Aroon">
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[#00b1c7] text-[103px] top-[110px] whitespace-nowrap">Aroon</p>
      ...
      <div className="absolute contents left-[930px] top-[493px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Settings" additionalClassNames="left-[calc(50%-700.5px)] top-[calc(50%-945.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[18.02%_70.83%_81.74%_28.75%]" />
      </div>
      ...
      <div className="absolute contents left-[809px] top-[715px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Maximize Pane" additionalClassNames="left-[calc(50%-804.5px)] top-[calc(50%-723.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[25.65%_73.95%_74.11%_25.63%]" />
      </div>
      <div className="absolute contents left-[938px] top-[715px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Minimize Pane" additionalClassNames="left-[calc(50%-676.5px)] top-[calc(50%-723.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[25.65%_70.11%_74.11%_29.47%]" />
      </div>
      <div className="absolute contents left-[809px] top-[604px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Move Pane Up" additionalClassNames="left-[calc(50%-806.5px)] top-[calc(50%-834.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[21.84%_74.01%_77.92%_25.57%]" />
      </div>
      <div className="absolute contents left-[934px] top-[604px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Move Pane Down" additionalClassNames="left-[calc(50%-674px)] top-[calc(50%-834.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[21.84%_70.03%_77.92%_29.55%]" />
      </div>
      <div className="absolute contents left-[1090px] top-[604px]" data-name="tooltip">
        <TooltipBackgroundImageAndText text="Remove Pane" additionalClassNames="left-[calc(50%-527px)] top-[calc(50%-834.5px)]" />
        <BackgroundImage2 additionalClassNames="inset-[21.84%_65.62%_77.92%_33.96%]" />
      </div>
      ...
      <div className="absolute contents left-[808px] top-[493px]" data-name="copy">
        ...
        <div className="absolute contents left-[808px] top-[493px]" data-name="tooltip">
          ...
          <BackgroundImage2 additionalClassNames="inset-[18.02%_74.7%_81.74%_24.88%]" />
        </div>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[124px] not-italic text-[70px] text-black top-[1574px] whitespace-nowrap">Default</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1724px] not-italic text-[70px] text-black top-[1574px] whitespace-nowrap">Menu_on_hover</p>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[124px] overflow-clip top-[1716px] w-[1440px]" data-name="Aroon_default">
        ...
        <div className="absolute bg-white h-[199px] left-[61px] overflow-clip top-[605px] w-[1367px]" data-name="indicator_field">
          ...
          <IndicatorBackgroundImage1 />
          <NumbersBackgroundImage text="0.00%" text1="20.00%" text2="40.00%" text3="60.00%" text4="80.00%" text5="100.00%" />
          <BackgroundImage5 />
          <CoordinatesBackgroundImage text="18.71%" text1="14.29%" additionalClassNames="px-[2px]" />
          <IndicatorMenuShortBackgroundImage text="Aroon" text1="14" additionalClassNames="left-[17px] top-[9px]" />
        </div>
      ...
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1724px] overflow-clip top-[1716px] w-[1440px]" data-name="Aroon_default">
        <FooterBarBackgroundImageAndText text="12: 25: 50 (UTC)" />
        <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]" data-name="chart">
          <div className="absolute h-[772px] left-0 top-0 w-[1368px]" data-name="chart_items">
            <ChartLayoutBackgroundImage />
        ...
        <div className="absolute bg-white h-[199px] left-[61px] overflow-clip top-[605px] w-[1367px]" data-name="indicator_field">
          ...
          <NumbersBackgroundImage text="0.00%" text1="20.00%" text2="40.00%" text3="60.00%" text4="80.00%" text5="100.00%" />
          <BackgroundImage5 />
          <CoordinatesBackgroundImage text="18.71%" text1="14.29%" />
          <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[17px] px-[12px] py-px rounded-[6px] top-[9px]" data-name="indicator_menu/extended">
            ...
            <NameBackgroundImage text="Aroon" text1="14" />
      ...
      <div className="absolute border border-[#efeff4] border-solid h-[344px] left-[1737px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[473px] w-[406px]" data-name="indicator_menu/Aroon /style">
        <div className="absolute bg-white h-[344px] left-[-1px] top-[-1px] w-[406px]" data-name="bg_modal" />
        ...
        <div className="absolute contents left-[14px] top-[107px]" data-name="option">
          <div className="absolute left-[calc(33.33%+12.67px)] size-[32px] top-[108px]" data-name="dropdown/color/default">
            <BackgroundImage8 />
            <div className="absolute bg-[#e92323] inset-[12.5%] rounded-[2px]" data-name="color" />
          </div>
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[115px] whitespace-nowrap">Aroon Up</p>
        ...
        <div className="absolute contents left-[14px] top-[159px]" data-name="option">
          ...
          <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[51px] not-italic text-[#1f1f1f] text-[14px] top-[167px] whitespace-nowrap">Aroon Down</p>
        ...
        <ModalHeaderLBackgroundImage>{`Aroon `}</ModalHeaderLBackgroundImage>
      </div>
      <div className="absolute bg-white content-stretch flex gap-[12px] items-center left-[125px] px-[12px] py-px rounded-[6px] top-[507px]" data-name="indicator_menu/extended">
        <div aria-hidden="true" className="absolute border border-[#efeff4] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[1px_8px_32px_0px_rgba(49,49,49,0.08)]" />
        <NameBackgroundImage text="Aroon" text1="14" />
        <div className="content-stretch flex items-center leading-[0] relative shrink-0" data-name="tools">
          <BackgroundImage7 />
      ...
      <div className="absolute bg-white content-stretch flex font-['Source_Sans_Pro:Regular',sans-serif] gap-[8px] items-center leading-[normal] left-[201px] not-italic px-[2px] py-[8px] text-[12px] top-[465px] whitespace-nowrap" data-name="coordinates">
        <p className="relative shrink-0 text-[#e92323]">18.71%</p>
        <p className="relative shrink-0 text-[#1da1f2]">14.29%</p>
      </div>
      <IndicatorMenuShortBackgroundImage text="Aroon" text1="14" additionalClassNames="left-[125px] top-[465px]" />
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1737px] not-italic text-[70px] text-black top-[349px] whitespace-nowrap">Settings</p>
      <div className="absolute border border-[#efeff4] border-solid h-[271px] left-[2173px] overflow-clip rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[475px] w-[406px]" data-name="indicator_menu/Aroon/inputs">
        <div className="absolute bg-white h-[271px] left-[-1px] shadow-[1px_8px_40px_0px_rgba(49,49,49,0.06)] top-[-1px] w-[406px]" data-name="bg_modal" />
        <div className="absolute contents left-[14px] top-[159px]" data-name="option">
          ...
          <div className="absolute h-[32px] left-[calc(33.33%+12.67px)] top-[160px] w-[139px]" data-name="input/M/filled">
            <div className="absolute flex h-[32px] items-center justify-center left-0 right-0 top-0">
              <BackgroundImage9 additionalClassNames="h-[109px] w-[32px]" />
            </div>
            <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[12px] not-italic text-[#1f1f1f] text-[14px] top-[6px] whitespace-nowrap">14</p>
          </div>
        </div>
        <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[14px] not-italic text-[#1f1f1f] text-[14px] top-[113px] whitespace-nowrap">Resolution</p>
        <div className="absolute h-[32px] left-[calc(33.33%+12.33px)] top-[107px] w-[139px]" data-name="dropdown/text_centered/long/default">
          <div className="absolute bg-white border border-[#efeff4] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
          <IconsSmallChevronDownBackgroundImage />
      ...
      <div className="absolute h-[48px] left-[1859px] top-[856px] w-[159px]" data-name="line_menu/line_width">
      ...
      <div className="absolute h-[32px] left-[2031px] top-[856px] w-[125px]" data-name="dropdown/text+icon/active">
      ...
      <div className="absolute h-[433px] left-[2031px] top-[892px] w-[179px]" data-name="dropdown_menu/styles">
      ...
      <div className="absolute h-[32px] left-[1740px] top-[856px] w-[106px]" data-name="dropdown/text_centered/short/active">
        <div className="absolute bg-white border border-[#00b1c7] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
        <IconsSmallChevronUpBackgroundImage />
        <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[calc(50%-7px)] not-italic text-[#1f1f1f] text-[14px] text-center top-[calc(50%-10px)] whitespace-nowrap">Values</p>
      </div>
      <div className="absolute contents inset-[30.85%_44.6%_57.6%_52.22%]" data-name="dropdown/precision">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[30.85%_44.6%_57.6%_52.22%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <div className="absolute inset-[31.12%_44.62%_67.78%_52.24%]" data-name="list_item/32/centered">
        ...
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="0" additionalClassNames="inset-[32.22%_44.62%_66.68%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="1" additionalClassNames="inset-[33.32%_44.62%_65.58%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="2" additionalClassNames="inset-[34.42%_44.62%_64.48%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="3" additionalClassNames="inset-[35.52%_44.62%_63.38%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="4" additionalClassNames="inset-[36.62%_44.62%_62.28%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="5" additionalClassNames="inset-[37.72%_44.62%_61.18%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="6" additionalClassNames="inset-[38.82%_44.62%_60.08%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="7" additionalClassNames="inset-[39.92%_44.62%_58.98%_52.24%]" />
        <DropdownPrecisionListItem32CenteredBackgroundImageAndText text="8" additionalClassNames="bg-white inset-[41.02%_44.62%_57.87%_52.24%]" />
      </div>
      <div className="absolute h-[32px] left-[2590px] top-[869px] w-[139px]" data-name="dropdown/text_centered/long/active">
        <div className="absolute bg-white border border-[#00b1c7] border-solid h-[32px] left-0 right-0 rounded-[4px] top-0" data-name="box" />
        <IconsSmallChevronUpBackgroundImage />
        <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[calc(50%-10px)] not-italic text-[#1f1f1f] text-[14px] text-center top-[calc(50%-10px)] whitespace-nowrap">Same as symbol</p>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.5] left-[2590px] not-italic text-[16px] text-black top-[836px] whitespace-nowrap">Resolution</p>
      <div className="absolute contents left-[2590px] top-[905px]" data-name="dropdown/resolution">
        <div className="absolute bg-white border border-[#efeff4] border-solid inset-[31.12%_18.1%_52.92%_77.73%] rounded-[4px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)]" data-name="bg" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="Same as symbol" additionalClassNames="top-[913px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 minute" additionalClassNames="top-[945px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="3 minutes" additionalClassNames="top-[977px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="5 minutes" additionalClassNames="top-[1009px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="15 minutes" additionalClassNames="top-[1041px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="30 minutes" additionalClassNames="top-[1073px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="45 minutes" additionalClassNames="top-[1105px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 hour" additionalClassNames="top-[1137px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="2 hours" additionalClassNames="top-[1169px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="3 hours" additionalClassNames="top-[1201px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="4 hours" additionalClassNames="top-[1233px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 day" additionalClassNames="top-[1265px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 week" additionalClassNames="top-[1297px]" />
        <DropdownResolutionListItem32SBackgroundImageAndText text="1 month" additionalClassNames="top-[1329px]" />
      </div>
      <div className="absolute h-[252px] left-[1542px] top-[859px] w-[164px]" data-name="tool_menu/color">
