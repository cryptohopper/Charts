...
import svgPaths from "./svg-iov6mk2nyk";
...
type ModalHeaderLTextProps = {
  text: string;
};

function ModalHeaderLText({ text }: ModalHeaderLTextProps) {
  return (
    <div className="absolute h-[41px] left-[calc(33.33%+37px)] top-[365px] w-[406px]">
...
function SaveText({ text }: SaveTextProps) {
  return (
    <div className="absolute contents left-[calc(33.33%+52px)] top-[488px]">
      <p className="absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[39.31%] not-italic right-[53.61%] text-[#222268] text-[14px] top-[calc(50%+42px)] whitespace-nowrap">{text}</p>
      <div className="absolute left-[calc(33.33%+52px)] overflow-clip size-[24px] top-[488px]" data-name="icons/download">
        <div className="absolute inset-[12.5%]">
          <div className="absolute inset-[-2.78%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
              <g id="download">
                <path d={svgPaths.pbc54180} id="Vector" stroke="var(--stroke-0, #222268)" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M4.5 7.5L9.5 12.5L14.5 7.5" id="Vector_2" stroke="var(--stroke-0, #222268)" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M9.5 12.5V0.5" id="Vector_3" stroke="var(--stroke-0, #222268)" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </svg>
          </div>
        </div>
...
function Input() {
  return (
    <div className="absolute contents left-[calc(33.33%+52px)] top-[430px]">
      <div className="absolute bg-white border border-[#efeff4] border-solid h-[40px] left-[calc(33.33%+52px)] rounded-[4px] top-[430px] w-[281px]" data-name="input" />
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[20px] left-[37.78%] not-italic right-[43.89%] text-[#8e8e93] text-[14px] top-[calc(50%-10px)] whitespace-nowrap">{`http://www.cryptohopper.com/dsfdfsffsg//gc`}</p>
    </div>
  );
}
    ...
    <div className="absolute h-[772px] left-[60px] overflow-clip rounded-[6px] top-[64px] w-[1368px]">
      ...
      <div className="absolute h-[739px] left-0 overflow-clip top-0 w-[1303px]">
        <div className="absolute contents left-0 top-0">
          ...
          <Helper additionalClassNames="top-[47px]" />
          <Helper additionalClassNames="top-[12px]" />
          <Helper additionalClassNames="top-[82px]" />
          <Helper additionalClassNames="top-[117px]" />
          <Helper additionalClassNames="top-[187px]" />
          <Helper additionalClassNames="top-[222px]" />
          <Helper additionalClassNames="top-[292px]" />
          <Helper additionalClassNames="top-[327px]" />
          <Helper additionalClassNames="top-[397px]" />
          <Helper additionalClassNames="top-[432px]" />
          <Helper additionalClassNames="top-[502px]" />
          <Helper additionalClassNames="top-[537px]" />
          <Helper additionalClassNames="top-[607px]" />
          <Helper additionalClassNames="top-[642px]" />
          <Helper additionalClassNames="top-[152px]" />
          <Helper additionalClassNames="top-[257px]" />
          <Helper additionalClassNames="top-[362px]" />
          <Helper additionalClassNames="top-[467px]" />
          <Helper additionalClassNames="top-[572px]" />
          <Helper additionalClassNames="top-[677px]" />
          <Helper additionalClassNames="top-[712px]" />
...
export default function Share() {
  return (
    <div className="bg-[#efeff4] relative size-full" data-name="Share">
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[122px] overflow-clip top-[471px] w-[1440px]" data-name="Share">
        ...
        <div className="absolute contents left-[calc(33.33%+37px)] top-[365px]" data-name="modal/save_image/default">
          <div className="absolute bg-white border border-[#f8f8ff] border-solid h-[169px] left-[calc(33.33%+37px)] rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[365px] w-[406px]" data-name="bg_modal" />
          <Input />
          <div className="absolute h-[40px] left-[calc(55.56%+28px)] top-[430px] w-[80px]" data-name="button/primary/M/default">
          ...
          <SaveText text="Download Image" />
          <ModalHeaderLText text="Image URL" />
        </div>
      </div>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[120px] not-italic text-[70px] text-black top-[334px] whitespace-nowrap">Share default</p>
      <p className="absolute font-['Source_Sans_Pro:Bold',sans-serif] leading-[1.5] left-[1638px] not-italic text-[70px] text-black top-[334px] whitespace-nowrap">Share success</p>
      <div className="absolute bg-[#f8f8ff] h-[900px] left-[1638px] overflow-clip top-[471px] w-[1440px]" data-name="Share">
        <FooterBarText text="12: 25: 50 (UTC)" />
        <Chart />
        <ToolsBarDefault className="absolute h-[836px] left-0 top-[64px] w-[48px]" />
        <UpperBarDefault className="absolute h-[40px] left-[60px] top-[12px] w-[1368px]" />
        ...
        <div className="absolute contents left-[calc(33.33%+37px)] top-[365px]" data-name="modal/save_image/default">
          <div className="absolute bg-white border border-[#f8f8ff] border-solid h-[169px] left-[calc(33.33%+37px)] rounded-[6px] shadow-[1px_8px_40px_0px_rgba(67,67,67,0.12)] top-[365px] w-[406px]" data-name="bg_modal" />
          <Input />
          <div className="absolute h-[40px] left-[calc(55.56%+28px)] top-[430px] w-[80px]" data-name="button/primary/M/success">
            <div className="absolute bg-[#29c79e] h-[40px] left-0 right-0 rounded-[3px] top-0" data-name="bg" />
            <p className="-translate-x-1/2 absolute font-['Source_Sans_Pro:SemiBold',sans-serif] leading-[normal] left-[calc(50%-0.5px)] not-italic text-[14px] text-center text-white top-[calc(50%-9px)] whitespace-nowrap">Copied</p>
          </div>
          <SaveText text="Download Image" />
          <ModalHeaderLText text="Image URL" />
        </div>
      ...
      <p className="absolute font-['Source_Sans_Pro:Regular',sans-serif] leading-[1.5] left-[1240px] not-italic text-[16px] text-black top-[71px] whitespace-nowrap">Share</p>
      <div className="absolute h-[60.5px] left-[1255px] top-[94.5px] w-[12px]">
