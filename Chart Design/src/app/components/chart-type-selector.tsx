...
// Export the selected chart type's toolbar icon
    ...
    case "candles":
      return (
        <svg width="12" height="18" viewBox="0 0 12 18" fill="none">
          <path d="M3 17.5V0.5" stroke={IC} strokeLinecap="round" strokeLinejoin="round" />
          <rect x="1" y="3.3" width="4" height="11.3" fill="var(--hc-surface)" stroke={IC} />
          <path d="M9 14.5V0.5" stroke={IC} strokeLinecap="round" strokeLinejoin="round" />
          <rect x="7" y="3.3" width="4" height="8.4" fill="var(--hc-surface)" stroke={IC} />
        </svg>
      );
    case "hollow":
      return (
        <svg width="12" height="18" viewBox="0 0 12 18" fill="none">
          <path d="M3 17.5V0.5" stroke={IC} strokeLinecap="round" />
          <rect x="1" y="3.3" width="4" height="11.3" stroke={IC} strokeDasharray="2 1" />
          <path d="M9 14.5V0.5" stroke={IC} strokeLinecap="round" />
          <rect x="7" y="3.3" width="4" height="8.4" stroke={IC} />
        </svg>
      );
    case "bar":
      return (
        <svg width="14" height="18" viewBox="0 0 14 18" fill="none">
          <path d="M4 1V17" stroke={IC} strokeLinecap="round" />
          <path d="M4 4H1" stroke={IC} strokeLinecap="round" />
          <path d="M4 14H7" stroke={IC} strokeLinecap="round" />
          <path d="M10 3V15" stroke={IC} strokeLinecap="round" />
          <path d="M10 5H7" stroke={IC} strokeLinecap="round" />
          <path d="M10 13H13" stroke={IC} strokeLinecap="round" />
        </svg>
      );
    case "line":
      return (
        <svg width="18" height="14" viewBox="0 0 18 14" fill="none">
          <path d="M1 11L5 6L9 8.5L13 2L17 5" stroke={IC} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case "area":
      return (
        <svg width="18" height="16" viewBox="0 0 18 16" fill="none">
          <path d="M1 11L5 6L9 8.5L13 2L17 5V15H1V11Z" fill={IC} fillOpacity="0.08" />
          <path d="M1 11L5 6L9 8.5L13 2L17 5" stroke={IC} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case "baseline":
      return (
        <svg width="18" height="14" viewBox="0 0 18 14" fill="none">
          <path d="M1 8H17" stroke={IC} strokeOpacity="0.2" strokeDasharray="2 2" />
          <path d="M1 11L4 6L7 9L10 3L13 7L17 4" stroke={IC} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      );
    case "heikin":
      return (
        <svg width="12" height="18" viewBox="0 0 12 18" fill="none">
          <path d="M3 17V1" stroke={IC} strokeLinecap="round" />
          <rect x="1" y="4" width="4" height="9" fill={IC} fillOpacity="0.1" stroke={IC} />
          <path d="M9 15V1.5" stroke={IC} strokeLinecap="round" />
          <rect x="7" y="3.5" width="4" height="7" fill={IC} fillOpacity="0.1" stroke={IC} />
        </svg>
      );
    case "renko":
      return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <rect x="0.5" y="8.5" width="3.5" height="3.5" stroke={IC} />
          <rect x="4" y="4.5" width="3.5" height="3.5" stroke={IC} />
          <rect x="7.5" y="8.5" width="3.5" height="3.5" stroke={IC} />
          <rect x="11" y="4.5" width="3.5" height="3.5" stroke={IC} />
        </svg>
      );
    default:
      return <CandlestickIcon color={IC} />;
  }
}
